...
class BugFinder:
    ...
    def _find_sink_addresses(self):
        ...
        print("SINK STUFF")
        print(type(SINK_FUNCS))
        print(SINK_FUNCS)
        print(type(self._sink_addrs[0]))
        print(self._sink_addrs[0])
    ...
    def _vuln_analysis(self, p, cfg, cpf_name, seed_addr, info, max_size):
        ...
        print("SINK ADDRS: ", self._sink_addrs)
