...
<div class="formfontdesc" id="lb_note" style="color:#FFCC00; display:none;"><#2471#></div>
<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
<tr>
<th><#1813#></th>
<td>
<input type="radio" name="dmz_enable" class="input" onclick="dmz_on_off()" ><#188#>
<input type="radio" name="dmz_enable" class="input" onclick="dmz_on_off()" ><#187#>
</td>
</tr>
<tr id="wan_dmz_ip_tr">
<th colspan=2><#1802#></th>
</tr>
<tr id="dmz_ip_tr">
<th><#2263#></th>
<td>
