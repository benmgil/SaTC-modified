...
<title><#828#> - Subnet Management</title>
...
alertMsg("<#3783#>", ipConflict_cp.ipAddr, ipConflict_cp.netLegalRangeStart, ipConflict_cp.netLegalRangeEnd);
return false;
}
}
if(cp_freewifi_support){
...
<tr>
<td align="left">
<span class="formfonttitle"><#753#></span>
...
<th><#2377#></th>
<td>
<input type="radio" value="1" name="radioDHCPEnable" class="content_input_fd" checked><#188#>
<input type="radio" value="0" name="radioDHCPEnable" class="content_input_fd"><#187#>
</td>
</tr>
<tr>
...
<input type="radio" value="1" name="dhcp_static" /><#188#>
<input type="radio" value="0" name="dhcp_static" /><#187#>
</td>
</tr>
</table>
...
<thead>
<tr>
<td colspan="3" id="GWStatic"><#2394#>&nbsp;(<#2484#>&nbsp;<span id="max_staticIp_num" style="color:#FFF;">8</span>)</td>
</tr>
</thead>
<tr>
...
<input id="saveButton" class="button_gen" type="button" onclick="" value="<#1615#>">
</div>
</div>
...
<div>&nbsp;</div>
<div class="formfonttitle"><#378#> - <#3036#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#412#></div>
<div style="margin-left:8px; margin-bottom:7px;"> <div style="font-size:12px; font-weight:800;display:table-cell;vertical-align:bottom;"><#413#>&nbsp;(<#2484#>&nbsp;8)</div><div style="display:table-cell;padding-left:6px;"><input id="add_subnet_btn" type="button" class="add_btn" onClick="add_subnet();" value=""></div></div>
...
<tr>
<th style="width:19%"><#2879#></th>
<th style="width:19%"><#305#></th>
<th style="width:19%"><#2400#></th>
<th style="width:19%"><#2398#></th>
<th style="width:10%"><#2390#></th>
<th style="width:7%"><#2823#></th>
<th><#1599#></th>
</tr>
</table>
