...
document.getElementById("repeaterModeHint_desc").innerHTML = "<#1614#>";
document.getElementById("repeaterModeHint").style.display = "";
}
else{
show_wl_wdslist();
...
code +='<tr><td style="color:#FFCC00;"><#2285#></td>';
}
else{
...
code += '<div style="text-decoration:underline;font-weight:bolder;" onclick="rescan();"><#1364#></div>';
}
else{
...
document.getElementById("check_mac").innerHTML="<br><br><#343#>";
...
childsel.style.color="#FFCC00";
obj.parentNode.appendChild(childsel);
document.getElementById("check_mac").innerHTML="<br><br><#306#>";
document.getElementById("check_mac").style.display = "";
return false;
}else{
...
<div>&nbsp;</div>
<div class="formfonttitle"><#371#> - <#374#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#3559#></div>
<div class="formfontdesc" style="color:#FFCC00;"><#905#></div>
<div class="formfontdesc" style="color:#FFCC00;margin-left:28px;">
<#3560#>&nbsp;<#3561#><br><#2947#>
</div>
<div class="formfontdesc"><#3562#>
<ol>
<li><#3563#></li>
<li><#3564#></li>
<li><#3565#></li>
...
<div id="wl_bw_hint" style="font-size:13px;font-family: Arial, Helvetica, sans-serif;color:#FC0;margin-left:28px;"><#3567#></div>
<div id="wl_ch_hint" style="font-size:13px;font-family: Arial, Helvetica, sans-serif;color:#FC0;margin-left:28px;"><#3568#></div>
...
<td id="repeaterModeHint_desc" colspan="2" style="color:#FFCC00;height:30px;" align="center"><#456#></td>
</tr>
...
<option value="0" <% nvram_match("wl_mode_x", "0","selected"); %>><#3615#></option>
<option value="1" <% nvram_match("wl_mode_x", "1","selected"); %>><#3616#></option>
<option value="2" <% nvram_match("wl_mode_x", "2","selected"); %>><#3617#></option>
</select>
</td>
</tr>
...
<td>
<input type="radio" value="1" name="wl_wdsapply_x" class="input" <% nvram_match("wl_wdsapply_x", "1", "checked"); %>><#188#>
<input type="radio" value="0" name="wl_wdsapply_x" class="input" <% nvram_match("wl_wdsapply_x", "0", "checked"); %>><#187#>
</td>
</tr>
</table>
...
<td colspan="4"><#3584#>&nbsp;(<#2484#>&nbsp;4)</td>
</tr>
</thead>
<tr id="wds_list_add_delete_field">
<th width="80%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,10);"><#3584#></th>
<th class="edit_table" width="20%"><#2483#></th>
</tr>
...
<img style="float:left;" id="pull_arrow" height="14px;" src="/images/arrow-down.gif" onclick="pullLANIPList(this);" title="<#2910#>" onmouseover="over_var=1;" onmouseout="over_var=0;">
