...
var category_name = ["<#1174#>", "<#1189#>", "<#1192#>", "<#1196#>"];
var sub_category_name = [["<#1176#>", "<#1177#>", "<#1178#>"],
["<#1179#>", "<#1180#>", "<#1181#>", "<#1182#>", "<#1183#>"],
["<#1194#>", "<#1195#>"],
["<#1197#>", "<#1198#>", "<#1199#>"]];
var category_desc = ["<#1175#>",
"<#1190#>",
"<#1193#>",
"<#1200#>"];
var apps_filter_row = apps_filter.split("<");
...
code += '<thead><tr>';
code += '<td colspan="5"><#1574#>&nbsp;(<#2484#>&nbsp;'+MaxRule_bwdpi_wrs+')</td>';
code += '</tr></thead>';
code += '<tbody>';
code += '<tr>';
code += '<th width="5%" height="30px" title="<#2909#>">';
code += '<input id="selAll" type="checkbox" onclick="selectAll(this, 0);" value="">';
code += '</th>';
code += '<th width="40%"><#1484#> (<#2775#>)</th>';
code += '<th width="40%"><#1184#></th>';
code += '<th width="10%"><#2483#></th>';
code += '</tr>';
code += '<tr id="main_element">';
code += '<td style="border-bottom:2px solid #000;" title="<#3603#>/<#1472#>">';
...
<tr>
<td align="left">
<div class="formfonttitle" style="width:400px"><#1250#> - <#1173#></div>
</td>
<td>
...
<table class="block_filter_name_table_pressed"><tr><td style="line-height:13px;"><#1173#></td></tr></table>
</div>
...
<table class="block_filter_name_table"><tr><td style="line-height:13px;"><#3085#></td></tr></table>
</div>
</a>
</div>
</td>
...
<span><#1191#></span>
<div>
<a id="faq" href="" style="text-decoration:underline;" target="_blank"><#457#> FAQ</a>
</div>
</td>
</tr>
</table>
