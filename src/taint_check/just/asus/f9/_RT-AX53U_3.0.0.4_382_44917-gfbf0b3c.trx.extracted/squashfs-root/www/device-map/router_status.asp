...
var led_table = ["<#1472#>", "<#2811#>", "<#2517#>", "<#2156#>"];
...
var code = '';
if(system.INTELplatform){
code += '<div class="info-title"><#3911#></div>';
...
code += '<div class="info-block"><div class="info-title"><#2374#></div><div class="info-content">'+ _lanIP +'</div></div>';
code += '<div class="info-block"><div class="info-title"><#2725#></div><div class="info-content">'+ variable.secret_code +'</div></div>';
if(variable.serial_no != ''){
code += '<div class="info-block"><div class="info-title"><#2922#></div><div class="info-content">'+ variable.serial_no +'</div></div>';
}
code += '<div class="info-block"><div class="info-title">LAN <#357#></div><div class="info-content">'+ variable.lan_hwaddr +'</div></div>';
if(system.band2gSupport){
code += '<div class="info-block"><div class="info-title">2.4 GHz <#357#></div><div class="info-content">'+ variable.wl0_hwaddr +'</div></div>';
}
if(system.triBandSupport){
if(system.band6gSupport){
code += '<div class="info-block"><div class="info-title">5 GHz <#357#></div><div class="info-content">'+ variable.wl1_hwaddr +'</div></div>';
code += '<div class="info-block"><div class="info-title">6 GHz <#357#></div><div class="info-content">'+ variable.wl2_hwaddr +'</div></div>';
}
else{
code += '<div class="info-block"><div class="info-title">5 GHz-1 <#357#></div><div class="info-content">'+ variable.wl1_hwaddr +'</div></div>';
code += '<div class="info-block"><div class="info-title">5 GHz-2 <#357#></div><div class="info-content">'+ variable.wl2_hwaddr +'</div></div>';
}
}
else{
code += '<div class="info-block"><div class="info-title">5 GHz <#357#></div><div class="info-content">'+ variable.wl1_hwaddr +'</div></div>';
...
if(system.band60gSupport){
code += '<div class="info-block"><div class="info-title">LAN <#357#></div><div class="info-content">'+ variable.wl3_hwaddr +'</div></div>';
}
...
var modeDesc = ['<#3746#>', '<#3748#>', '<#3750#>', '', '<#1473#>'];
code += '<div class="division-block"><#3739#></div>';
...
code += '<div class="info-content"><#2047#> '+ yadns_clients[i] +'</div>';
code += '</div>';
}
}
...
var code = '<div class="division-block"><#724#></div>';
code += '<div>';
for(i=0;i<core_num;i++){
...
var code = '<div class="division-block"><#726#></div>';
code += '<div>';
code += '<div>';
code += '<div class="display-flex flex-a-center ram-content">';
code += '<div class="ram-text-width"><#727#></div>';
code += '<div class="ram-text-width"><#728#></div>';
code += '<div class="ram-text-width"><#729#></div>';
code += '</div>';
code += '<div class="display-flex flex-a-center ram-content">';
...
var code = '<div class="division-block"><#720#></div>';
code += '<div>';
code += '<div class="display-flex flex-a-center table-header">';
code += '<div class="port-block-width table-content"><#721#></div>';
code += '<div class="port-block-width table-content"><#719#></div>';
code += '</div>';
...
<div id="wireless_tab" class="tab-block" onclick="switchTab(this.id)"><#371#></div>
<div id="status_tab" class="tab-block tab-click" onclick="switchTab(this.id)"><#719#></div>
