...
var code = "";
code += "<tr>";
code += "<th style='width:20%;text-align:left'><#859#></th>";
code += "<th style='width:30%;text-align:left'><#2775#> / <#1484#></th>";
code += "<th style='width:50%;text-align:left'><#1732#></th>";
code += "</tr>";
...
<div>&nbsp;</div>
<div id="content_title" class="formfonttitle"><#2524#> - <#878#></div>
...
<option value="all" selected><#1359#></option>
</select>
...
<div class="apply_gen">
<input class="button_gen" onClick="httpApi.cleanLog('web_history', updateWebHistory);" type="button" value="<#1597#>" >
<input class="button_gen" onClick="getWebHistory(document.form.clientList.value, '1')" type="button" value="<#1618#>">
</div>
</div>
</td>
</tr>
