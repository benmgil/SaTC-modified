...
desc += "<#1885#>: <% nvram_get("dslx_diag_duration"); %>\n";
...
<br>
<br>
<div class="feedback_info_0"><#1926#></div>
<br>
</div>
...
<#1902#>
<br><br>
<#1903#> : ( <a href="mailto:broadband_feedback@asus.com?Subject=<%nvram_get("productid");%>" target="_top" style="color:#FFCC00;">broadband_feedback@asus.com </a>) <#1904#>
<br>
<#1905#> :
<br>
<ul>
<li id="dbg_dsl_file" style="display:none;"><span onClick="get_split_feedback(1);" style="text-decoration: underline; color:#FFCC00; cursor:pointer;"><#1890#></span></li>
...
<#1902#>
<br><br>
<#1903#> : ( <a href="mailto:router_feedback@asus.com?Subject=<%nvram_get("productid");%>" target="_top" style="color:#FFCC00;">router_feedback@asus.com </a>) <#1904#>
&nbsp;<#1906#>
<br>
<#1905#> :
<br>
<ul>
<li id="dbg_rt_file" style="display:none;"><span onClick="get_split_feedback(1);" style="text-decoration: underline; color:#FFCC00; cursor:pointer;"><#1890#></span></li>
...
<br>
<div class="feedback_info_1">We are working hard to improve the firmware of <#829#> and your feedback is very important to us. We will use your feedbacks and comments to strive to improve your ASUS experience.</div>
<br>
</div>
...
<input class="button_gen" onclick="redirect();" type="button" value="<#360#>"/>
</div>
</td>
</tr>
</tbody>
