...
if(!wireless_tab){
buf.push('<li><a style="margin-right: 3px;" href="#" id="wireless_tabs"><#371#></a>');
buf.push('<ul>');
...
if(!internet_tab){
buf.push('<li><a style="margin-right: 3px;" href="#" id="internet_tabs"><#383#></a>');
buf.push('<ul>');
...
buf.push('<li><a style="margin-right: 3px;" href="javascript:tabSelect(\'' + arguments[i][0] + '\')" id="' + arguments[i][0] + '">' + '<#383#> (' + arguments[i][1] + ')</a></li>');
}
...
if(!wired_tab){
buf.push('<li><a style="margin-right: 3px;" href="#" id="wired_tabs"><#3110#></a>');
buf.push('<ul>');
