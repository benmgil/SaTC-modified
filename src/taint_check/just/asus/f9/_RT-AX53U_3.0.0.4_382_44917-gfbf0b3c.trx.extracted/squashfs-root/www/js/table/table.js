...
var $addTextHtml = $("<div>").html("" + _tableNameText + " ( <#2484#> " + _createRuleCount + " )").addClass("addRuleText");
...
alert("<#2353#> " + _createRuleCount + " <#2354#>");
return;
}
...
$titleHtml.html("<#2344#>");/*untranslated*/
...
$(this).closest(".editFrame").siblings('.table_clientlist_dropdown').children(".clientList_offline_expand").html("<#2685#>");
...
if(!validDuplicateFlag) {
tableApi.showHintMsg($(this), "<#2347#>");
return false;
}
}
