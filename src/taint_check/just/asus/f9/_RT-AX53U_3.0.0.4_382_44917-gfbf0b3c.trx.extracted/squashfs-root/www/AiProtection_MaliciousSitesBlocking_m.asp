...
if(info_bar == ''){
$('#recountIcon').hide();
code += '<div class="no-data"><#1172#></div>';
}
else{
$('#recountIcon').show();
...
code += '<div class="table-cell"><#1705#></div>';
code += '<div class="table-cell"><#1170#></div>';
code += '<div class="table-cell"><#1169#></div>';
code += '<div class="table-cell"><#1168#></div>';
code += '</div>';
...
code += '</div></div>';
code += '<div class="table-cell" data-title="<#1170#>">'+ cat_id_array[cat_id_index].description +'</div>';
var _name = dataObj[eventID].source[0];
if(clientList[_name]){
_name = clientList[_name].name;
}
code += '<div class="table-cell" data-title="<#1169#>">'+ _name +'</div>';
code += '<div class="table-cell" data-title="<#1168#>">'+ dataObj[eventID].destination[0] +'</div>';
code += '</div>';
}
}
else{
...
<div>
<div class="card-bg">
<div class="page-title"><#1247#></div>
<div class="split-Line"></div>
<div class="description-bar">
<div class="description-title"><#1660#></div>
<div class="description"><#1246#></div>
</div>
<div class="tm-logo">
...
<div class="event-hit"><#1239#></div>
</div>
<div class="card-lv1 card-lv1-bg">
<div class="flexbox flex-a-center flex-j-spaceB">
<div class="description"><#1265#></div>
...
<div class="page-title canvas-title"><#1154#></div>
</div>
<div class="canvas-bg">
<div class="chart-title"><#1239#></div>
