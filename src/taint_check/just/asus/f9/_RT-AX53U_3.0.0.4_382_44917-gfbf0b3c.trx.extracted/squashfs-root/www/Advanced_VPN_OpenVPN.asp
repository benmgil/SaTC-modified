...
document.getElementById("privateIP_notes").innerHTML = "<#3390#>";
...
document.getElementById(username_status).innerHTML = '<a class="hintstyle2" href="javascript:void(0);" onClick="showOpenVPNClients(\''+openvpnd_connected_clients[y].username+'\');"><#190#></a>';
break;
}
}
...
alert("<#3324#> " + origin_lan_ip);
vpnSubnet.focus();
vpnSubnet.select();
return false;
}
if(lan_ip_subnet == openvpn_server_subnet) {
alert("<#3322#>"+pool_start+" ~ "+pool_end);
vpnSubnet.focus();
vpnSubnet.select();
return false;
}
...
alert(document.form.vpn_server_r1.value + " <#326#>");
document.form.vpn_server_r1.focus();
document.form.vpn_server_r1.select();
return false;
}
...
alert(document.form.vpn_server_r2.value + " <#326#>");
document.form.vpn_server_r2.focus();
document.form.vpn_server_r2.select();
return false;
}
...
document.getElementById('openvpn_error_message').innerHTML = "<span><#3355#></span>";
document.getElementById('openvpn_error_message').style.display = "";
}
else if(vpnd_state != '2' && (vpn_server1_errno == '4' || vpn_server1_errno == '7')){
document.getElementById('openvpn_initial').style.display = "none";
document.getElementById('openvpn_error_message').innerHTML = "<span><#3356#></span>";
document.getElementById('openvpn_error_message').style.display = "";
}
else if(vpnd_state != '2' && vpn_server1_errno == '5'){
document.getElementById('openvpn_initial').style.display = "none";
document.getElementById('openvpn_error_message').innerHTML = "<span><#3357#></span>";
document.getElementById('openvpn_error_message').style.display = "";
}
else if(vpnd_state == '-1' && vpn_server1_errno == '0'){
document.getElementById('openvpn_initial').style.display = "none";
document.getElementById('openvpn_error_message').innerHTML = "<span><#3358#></span>";
document.getElementById('openvpn_error_message').style.display = "";
}
...
code +='<tr><td style="color:#FFCC00;" colspan="6"><#2285#></td>';
else{
...
document.getElementById("allowed_client_name").innerHTML = (flag==1)?"<#3294#>":"Common Name(CN)";
}
...
<tr>
<div class="description_down"><#3376#></div>
</tr>
<tr>
<div style="margin-left:30px; margin-top:10px;">
<p><#3367#> <span style="color:#FFCC00;">----- BEGIN xxx ----- </span>/<span style="color:#FFCC00;"> ----- END xxx -----</span> <#3368#>
<p><#3369#>
</div>
...
<input class="button_gen" type="button" onclick="save_keys('tls');" value="<#1616#>">
</div>
</td>
</tr>
</form>
...
<input class="button_gen" type="button" onclick="save_keys('secret');" value="<#1616#>">
</div>
</td>
</tr>
</tbody>
...
<div>&nbsp;</div>
<div class="formfonttitle"><#171#> - OpenVPN</div>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,6);"><#3543#></a></th>
<td>
...
<div id="portSuggestionBasic" style="color: #FFCC00;"><#3006#></div>
</td>
</tr>
...
<label for="vpn_server_client_access_local"><#3314#></label>
...
<label for="vpn_server_client_access_both"><#3315#></label>
...
<label for="vpn_server_client_access_custom" class="client_access_custom"><#1630#></label>
</td>
</tr>
...
<td>
<div id="export_div">
<input id="exportToLocal" class="button_gen" type="button" value="<#1475#>" />
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,27);"><#3331#></a></th>
<td>
<input id="exportCertToLocal" class="button_gen" type="button" value="<#1475#>" onClick="exportCert();"/>
</td>
</tr>
<tr id="openvpn_import_cert" style="display:none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,28);"><#3332#></a></th>
<td>
<input class="button_gen" type="button" value="<#1625#>" onClick="selectImportFile();"/>
</td>
</tr>
</table>
<div id="OpenVPN_setting" style="display:none;margin-top:8px;">
<div class="formfontdesc">
<#3349#>&nbsp;<#3351#>&nbsp;<#3352#>&nbsp;<#3350#><br>
<ol>
...
<td>
<input type="radio" name="vpn_server_x_eas" class="input" value="1"><#188#>
<input type="radio" name="vpn_server_x_eas" class="input" value="0"><#187#>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,4);"><#3363#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,5);"><#2278#></a></th>
<td>
...
<div id="portSuggestionAdvanced" style="color: #FFCC00;"><#3006#></div>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,15);"><#3383#></a></th>
<td>
<input type="radio" name="vpn_server_x_dns" class="input" value="1" onclick="update_visibility();"><#188#>
<input type="radio" name="vpn_server_x_dns" class="input" value="0" onclick="update_visibility();"><#187#>
</td>
</tr>
<tr id="server_pdns">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,16);"><#3337#></a></th>
<td>
<input type="radio" name="vpn_server_pdns" class="input" value="1" <% nvram_match_x("", "vpn_server_pdns", "1", "checked"); %>><#188#>
<input type="radio" name="vpn_server_pdns" class="input" value="0" <% nvram_match_x("", "vpn_server_pdns", "0", "checked"); %>><#187#>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,17);"><#3354#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,26);"><#3341#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,18);"><#3346#></a></th>
<td>
<select name="vpn_server_comp" class="input_option">
<option value="-1" <% nvram_match("vpn_server_comp","-1","selected"); %> ><#3604#></option>
<option value="no" <% nvram_match("vpn_server_comp","no","selected"); %> ><#833#></option>
<option value="yes" <% nvram_match("vpn_server_comp","yes","selected"); %> ><#3603#></option>
<option value="adaptive" <% nvram_match("vpn_server_comp","adaptive","selected"); %> ><#865#></option>
...
<option value="auto" <% nvram_match("vpn_server_firewall","auto","selected"); %> ><#154#></option>
<option value="external" <% nvram_match("vpn_server_firewall","external","selected"); %> ><#1837#></option>
<option value="custom" <% nvram_match("vpn_server_firewall","custom","selected"); %> ><#1630#></option>
</select>
</td>
</tr-->
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,9);"><#3339#></a></th>
<td>
<input type="radio" name="vpn_server_igncrt" class="input" value="1" onchange="enable_server_igncrt(this.value);" <% nvram_match_x("", "vpn_server_igncrt", "1", "checked"); %>><#188#>
<input type="radio" name="vpn_server_igncrt" class="input" value="0" onchange="enable_server_igncrt(this.value);" <% nvram_match_x("", "vpn_server_igncrt", "0", "checked"); %>><#187#>
<span id="Hint_fixed_tls_crypto" style="display:none;"><#3340#></span>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,7);"><#3338#></a></th>
<td>
...
<span id="server_tls_crypto_text" onclick="set_Keys('tls');" style="text-decoration:underline;cursor:pointer;"><#3379#></span>
<span id="server_static_crypto_text" onclick="set_Keys('secret');" style="text-decoration:underline;cursor:pointer;"><#3379#></span>
<!-- rm 2017/06/28 span id="server_custom_crypto_text"><#3378#></span-->
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,8);"><#2897#></a></th>
<td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,10);"><#3342#></a></th>
<td>
<select name="vpn_server_hmac" class="input_option">
<option value="-1" <% nvram_match("vpn_server_hmac","-1","selected"); %> ><#3604#></option>
...
<tr id="server_snnm">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,11);"><#3385#></a></th>
<td>
...
<tr id="server_dhcp">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,13);"><#3353#></a></th>
<td>
<input type="radio" name="vpn_server_dhcp" class="input" value="1" onclick="update_visibility();" <% nvram_match_x("", "vpn_server_dhcp", "1", "checked"); %>><#188#>
<input type="radio" name="vpn_server_dhcp" class="input" value="0" onclick="update_visibility();" <% nvram_match_x("", "vpn_server_dhcp", "0", "checked"); %>><#187#>
</td>
</tr>
<tr id="server_range">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,14);"><#3344#></a></th>
<td>
...
<tr id="server_local">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,12);"><#3377#></a></th>
<td>
...
<th><#3380#></th>
<td>
<input type="text" maxlength="4" class="input_6_table" name="vpn_server_poll" onKeyPress="return validator.isNumber(this,event);" value="<% nvram_get("vpn_server_poll"); %>" autocorrect="off" autocapitalize="off"> <#2530#>
<span style="color:#FC0">(<#3756#>)</span>
</td>
</tr-->
<tr id="server_plan">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,2);"><#3381#></a></th>
<td>
<input type="radio" name="vpn_server_plan" class="input" value="1" <% nvram_match_x("", "vpn_server_plan", "1", "checked"); %>><#188#>
<input type="radio" name="vpn_server_plan" class="input" value="0" <% nvram_match_x("", "vpn_server_plan", "0", "checked"); %>><#187#>
</td>
</tr>
<tr id="server_rgw">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,3);"><#3382#></a></th>
<td>
<input type="radio" name="vpn_server_rgw" class="input" value="1" <% nvram_match_x("", "vpn_server_rgw", "1", "checked"); %>><#188#>
<input type="radio" name="vpn_server_rgw" class="input" value="0" <% nvram_match_x("", "vpn_server_rgw", "0", "checked"); %>><#187#>
</td>
</tr>
<tr id="server_reneg">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,19);"><#3386#></a></th>
<td>
<input type="text" maxlength="5" class="input_6_table" name="vpn_server_reneg" value="<% nvram_get("vpn_server_reneg"); %>" autocorrect="off" autocapitalize="off"> <#2907#>
<span style="color:#FC0">(<#2936#> : -1)</span>
</td>
</tr>
<tr id="server_ccd">
<th><#3384#></th>
<td>
<input type="radio" name="vpn_server_ccd" class="input" value="1" onclick="update_visibility();" <% nvram_match_x("", "vpn_server_ccd", "1", "checked"); %>><#188#>
<input type="radio" name="vpn_server_ccd" class="input" value="0" onclick="update_visibility();" <% nvram_match_x("", "vpn_server_ccd", "0", "checked"); %>><#187#>
</td>
</tr>
<tr id="server_c2c">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,20);"><#3343#></a></th>
<td>
<input type="radio" name="vpn_server_c2c" class="input" value="1" <% nvram_match_x("", "vpn_server_c2c", "1", "checked"); %>><#188#>
<input type="radio" name="vpn_server_c2c" class="input" value="0" <% nvram_match_x("", "vpn_server_c2c", "0", "checked"); %>><#187#>
</td>
</tr>
<tr id="server_ccd_excl">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,21);"><#3345#></a></th>
<td>
<input type="radio" name="vpn_server_ccd_excl" class="input" value="1" onclick="update_visibility();" <% nvram_match_x("", "vpn_server_ccd_excl", "1", "checked"); %>><#188#>
<input type="radio" name="vpn_server_ccd_excl" class="input" value="0" onclick="update_visibility();" <% nvram_match_x("", "vpn_server_ccd_excl", "0", "checked"); %>><#187#>
</td>
</tr>
</table>
...
<th width="20%"><a id="allowed_client_name" class="hintstyle" href="javascript:void(0);" onClick="openHint(32,23);"><#3036#></a></th>
<th width="20%"><a id="allowed_client_name" class="hintstyle" href="javascript:void(0);" onClick="openHint(32,24);">Mask</a></th>
<th width="12%"><a id="allowed_client_name" class="hintstyle" href="javascript:void(0);" onClick="openHint(32,25);"><#2817#></a></th>
<th width="12%"><#2483#></th>
</tr>
<tr>
...
<option value="0" selected><#187#></option>
<option value="1"><#188#></option>
</select>
</td>
<td width="12%">
...
<input id="mailConfigPannelSubmiter" class="button_gen" type="button" value="<#1616#>">
