...
document.getElementById("cmdDesc").innerHTML = "<#2661#>";
}
else if(_val == "traceroute"){
document.getElementById("pingCNT_tr").style.display = "none";
document.getElementById("cmdDesc").innerHTML = "<#2664#>";
}
else{
document.getElementById("pingCNT_tr").style.display = "none";
document.getElementById("cmdDesc").innerHTML = "<#2658#>";
}
update_ntool_unit();
}
...
<div>&nbsp;</div>
<div class="formfonttitle"><#2649#> - <#2644#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc" id="cmdDesc"><#2661#></div>
...
<option class="content_input_fd" value="0" <% nvram_match("wans_ntool_unit", "0","selected"); %>><#1802#></option>
<option class="content_input_fd" value="1" <% nvram_match("wans_ntool_unit", "1","selected"); %>><#1809#></option>
</select>
</td>
</tr>
<tr>
...
<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;*margin-left:-3px;*margin-top:1px;" onclick="pullLANIPList(this);" title="<#2916#>" onmouseover="over_var=1;" onmouseout="over_var=0;">
...
<div class="apply_gen">
<span><input class="button_gen" id="cmdBtn" onClick="onSubmitCtrl(this, ' Refresh ')" type="button" value="<#2654#>"></span>
