...
code += '<span title="Change to default client icon" onclick="card_setDefaultIcon();"><#1601#></span>';
code += '<span id="card_changeIconTitle" title="Change client icon" style="margin-left:10px;" onclick="card_show_custom_image();"><#1595#></span>';
code += '</div>';
}
code += '</td>';
...
code += "<span onmouseover='return overlib(\"" + htmlEnDeCode.htmlEncode(block_internet_hint) +"\");' onmouseout='return nd();'><#1486#></span>";
code += '</div>';
...
code += '<div id="card_internetTimeScheduling" class="internetTimeEdit" style="float:right;margin-right:10px;" title="<#3085#>"></div>';
code += '</div>';
code += '<div class="clientList_line"></div>';
code += '<div style="height:33px;width:100%;margin:5px 0;">';
code += '<div style="width:65%;float:left;line-height:33px;">';
code += "<span onmouseover='return overlib(\"" + htmlEnDeCode.htmlEncode(ip_binding_hint) +"\");' onmouseout='return nd();'><#1488#></span>";
code += '</div>';
...
switch(rssi_t) {
case 1:
connectModeTip = "<#701#>: <#461#>\n";
break;
case 2:
connectModeTip = "<#701#>: <#462#>\n";
break;
case 3:
connectModeTip = "<#701#>: <#463#>\n";
break;
case 4:
connectModeTip = "<#701#>: <#464#>\n";
break;
}
if(stainfo_support) {
if(clientInfo.curTx != "")
...
connectModeTip += "<#859#>: " + clientInfo.wlConnectTime + "";
}
}
if(sw_mode != 4){
...
document.getElementById("card_client_ipMethod").style.display = "";
document.getElementById("card_client_ipMethod").innerHTML = "<#1492#>";
...
document.getElementById("card_client_login").innerHTML = "<#1490#>";
}
if(clientInfo.isPrinter) {
document.getElementById("card_client_printer").style.display = "";
document.getElementById("card_client_printer").innerHTML = "<#1491#>";
}
...
var opModeDes = ["none", "<#832#>", "<#448#>", "<#427#>", "<#435#>"];
...
document.getElementById("card_changeIconTitle").innerHTML = "<#1598#>";
}
else {
slideFlag = true;
slideUp("card_custom_image", 500);
document.getElementById("card_changeIconTitle").innerHTML = "<#1595#>";
}
}
}
...
code += '<thead><tr>';
code += '<td colspan="4">Client upload icon&nbsp;(<#2484#>&nbsp;100)</td>'; /*untranslated*/
code += '</tr></thead>';
code += '<tr>';
code += '<th width="45%"><#2712#></th>';
code += '<th width="30%"><#2710#></th>';
code += '<th width="15%"><#1485#></th>';
code += '<th width="10%"><#1599#></th>';
code += '</tr>';
code += '</table>';
...
code += '<input class="button_gen" type="button" onclick="uploadIcon_confirm();" value="<#1615#>">';
...
code +='<tr><td style="color:#FFCC00;" colspan="4"><#2285#></td></tr>';
...
drawSwitchModeHtml += "<div class='block_filter_name' style='color:#93A9B1;'><#1358#></div>";
drawSwitchModeHtml += "</div>";
drawSwitchModeHtml += "<div class='block_filter clientlist_ByInterface' style='cursor:pointer'>";
drawSwitchModeHtml += "<div class='block_filter_name' onclick='changeClientListViewMode();'><#3469#></div>";
drawSwitchModeHtml += "</div>";
}
else {
drawSwitchModeHtml += "<div class='block_filter clientlist_All' style='cursor:pointer'>";
drawSwitchModeHtml += "<div class='block_filter_name' onclick='changeClientListViewMode();'><#1358#></div>";
drawSwitchModeHtml += "</div>";
drawSwitchModeHtml += "<div class='block_filter_pressed clientlist_ByInterface'>";
drawSwitchModeHtml += "<div class='block_filter_name' style='color:#93A9B1;'><#3469#></div>";
drawSwitchModeHtml += "</div>";
}
drawSwitchModeHtml += "</div>";
...
code += "<thead><tr height='28px'><td id='td_all_list_title' colspan='" + wl_colspan + "'><#1495#>";
code += "<a id='all_expander'class='clientlist_expander' onclick='showHideContent(\"clientlist_all_list_Block\", this);'>[ <#1496#> ]</a>";
code += "</td></tr></thead>";
code += "<tr id='tr_all_title' height='40px'>";
code += "<th class='IE8HACK' width=" + obj_width[0] + "><#2205#></th>";
code += "<th class='IE8HACK' width=" + obj_width[1] + "><#1485#></th>";
code += "<th width=" + obj_width[2] + " onclick='sorter.addBorder(this);sorter.doSorter(2, \"str\", \"all_list\");' style='cursor:pointer;'><#2712#></th>";
code += "<th width=" + obj_width[3] + " onclick='sorter.addBorder(this);sorter.doSorter(3, \"num\", \"all_list\");' style='cursor:pointer;'><#3320#></th>";
code += "<th width=" + obj_width[4] + " onclick='sorter.addBorder(this);sorter.doSorter(4, \"str\", \"all_list\");' style='cursor:pointer;'><#2710#></th>";
if(!(isSwMode('mb') || isSwMode('ew')))
code += "<th width=" + obj_width[5] + " onclick='sorter.addBorder(this);sorter.doSorter(5, \"num\", \"all_list\");' style='cursor:pointer;'><#3469#></th>";
...
code += "<th width=" + obj_width[8] + " onclick='sorter.addBorder(this);sorter.doSorter(8, \"str\", \"all_list\");' style='cursor:pointer;'><#859#></th>";
}
code += "</tr>";
code += "</table>";
...
case "ByInterface" :
code += "<table width='100%' border='1' align='center' cellpadding='0' cellspacing='0' class='FormTable_table' style='margin-top:15px;'>";
code += "<thead><tr height='28px'><td colspan='" + wl_colspan + "'><#3110#>";
code += "<a id='wired_expander' class='clientlist_expander' onclick='showHideContent(\"clientlist_wired_list_Block\", this);'>[ <#1496#> ]</a>";
code += "</td></tr></thead>";
code += "<tr id='tr_wired_title' height='40px'>";
code += "<th class='IE8HACK' width=" + obj_width[0] + "><#2205#></th>";
code += "<th class='IE8HACK' width=" + obj_width[1] + "><#1485#></th>";
code += "<th width=" + obj_width[2] + " onclick='sorter.addBorder(this);sorter.doSorter(2, \"str\", \"wired_list\");' style='cursor:pointer;'><#2712#></th>";
code += "<th width=" + obj_width[3] + " onclick='sorter.addBorder(this);sorter.doSorter(3, \"num\", \"wired_list\");' style='cursor:pointer;'><#3320#></th>";
code += "<th width=" + obj_width[4] + " onclick='sorter.addBorder(this);sorter.doSorter(4, \"str\", \"wired_list\");' style='cursor:pointer;'><#2710#></th>";
if(!(isSwMode('mb') || isSwMode('ew')))
code += "<th width=" + obj_width[5] + " ><#3469#></th>";
if(stainfo_support && !(isSwMode('mb') || isSwMode('ew'))) {
...
code += "<th width=" + obj_width[8] + "><#859#></th>";
}
code += "</tr>";
code += "</table>";
...
code += "<a id='wl" + wl_map[wl_nband_title[i]] + "_expander' class='clientlist_expander' onclick='showHideContent(\"clientlist_wl" + wl_map[wl_nband_title[i]] + "_list_Block\", this);'>[ <#1496#> ]</a>";
code += "</td></tr></thead>";
code += "<tr id='tr_wl" + wl_map[wl_nband_title[i]] + "_title' height='40px'>";
code += "<th class='IE8HACK' width=" + obj_width[0] + "><#2205#></th>";
code += "<th class='IE8HACK' width=" + obj_width[1] + "><#1485#></th>";
code += "<th width=" + obj_width[2] + " onclick='sorter.addBorder(this);sorter.doSorter(2, \"str\", \"wl"+wl_map[wl_nband_title[i]]+"_list\");' style='cursor:pointer;'><#2712#></th>";
code += "<th width=" + obj_width[3] + " onclick='sorter.addBorder(this);sorter.doSorter(3, \"num\", \"wl"+wl_map[wl_nband_title[i]]+"_list\");' style='cursor:pointer;'><#3320#></th>";
code += "<th width=" + obj_width[4] + " onclick='sorter.addBorder(this);sorter.doSorter(4, \"str\", \"wl"+wl_map[wl_nband_title[i]]+"_list\");' style='cursor:pointer;'><#2710#></th>";
if(!(isSwMode('mb') || isSwMode('ew')))
code += "<th width=" + obj_width[5] + " onclick='sorter.addBorder(this);sorter.doSorter(5, \"num\", \"wl"+wl_map[wl_nband_title[i]]+"_list\");' style='cursor:pointer;'><#3469#></th>";
if(stainfo_support && !(isSwMode('mb') || isSwMode('ew'))) {
...
code += "<th width=" + obj_width[8] + " onclick='sorter.addBorder(this);sorter.doSorter(8, \"str\", \"wl"+wl_map[wl_nband_title[i]]+"_list\");' style='cursor:pointer;'><#859#></th>";
}
code += "</tr>";
code += "</table>";
...
code += "<a id='gn" + i + "_expander' class='clientlist_expander' onclick='showHideContent(\"clientlist_gn" + i + "_list_Block\", this);'>[ <#1496#> ]</a>";
code += "</td></tr></thead>";
code += "<tr id='tr_gn" + i + "_title' height='40px'>";
code += "<th class='IE8HACK' width=" + obj_width[0] + "><#2205#></th>";
code += "<th class='IE8HACK' width=" + obj_width[1] + "><#1485#></th>";
code += "<th width=" + obj_width[2] + " onclick='sorter.addBorder(this);sorter.doSorter(2, \"str\", \"gn"+i+"_list\");' style='cursor:pointer;'><#2712#></th>";
code += "<th width=" + obj_width[3] + " onclick='sorter.addBorder(this);sorter.doSorter(3, \"num\", \"gn"+i+"_list\");' style='cursor:pointer;'><#3320#></th>";
code += "<th width=" + obj_width[4] + " onclick='sorter.addBorder(this);sorter.doSorter(4, \"str\", \"gn"+i+"_list\");' style='cursor:pointer;'><#2710#></th>";
if(!(isSwMode('mb') || isSwMode('ew')))
code += "<th width=" + obj_width[5] + " onclick='sorter.addBorder(this);sorter.doSorter(5, \"num\", \"gn"+i+"_list\");' style='cursor:pointer;'><#3469#></th>";
if(stainfo_support && !(isSwMode('mb') || isSwMode('ew'))) {
...
code += "<th width=" + obj_width[8] + " onclick='sorter.addBorder(this);sorter.doSorter(8, \"str\", \"gn"+i+"_list\");' style='cursor:pointer;'><#859#></th>";
}
code += "</tr>";
code += "</table>";
...
if(!top.isIE8)
code += "<div style='text-align:center;margin-top:15px;'><input type='button' class='button_gen' onclick='exportClientListLog();' value='<#1475#>'></div>";
code += "</td></tr></tbody>";
code += "</table>";
divObj.innerHTML = code;
...
document.getElementById("all_expander").innerHTML = "[ <#1497#> ]";
}
}
else {
$.each(isWL_map, function(index, value){
...
document.getElementById("wired_expander").innerHTML = "[ <#1497#> ]";
}
}
else{
if(!sorter["wl"+index+"_display"]){
document.getElementById("clientlist_wl"+index+"_list_Block").style.display = "none";
document.getElementById("wl"+index+"_expander").innerHTML = "[ <#1497#> ]";
}
}
});
if(isSupport("amas")){
...
document.getElementById("gn"+i+"_expander").innerHTML = "[ <#1497#> ]";
}
}
}
}
...
clientListCode += "<tr id='tr_" + objID + "'><td style='color:#FFCC00;' colspan='" + wl_colspan + "'><#2285#></td></tr>";
}
else {
...
document.getElementById(_obj).innerText = "<#2684#>";
}
else {
slideFlag = true;
slideUp(_controlObj, 100);
document.getElementById(_obj).innerText = "<#2685#>";
}
}
}
...
htmlCode += "<div id='" + _containerID + "_clientlist_dropdown_expand' class='clientlist_dropdown_expand' onclick='expand_hide_Client(\"" + _containerID + "_clientlist_dropdown_expand\", \"" + _containerID + "_clientlist_offline\");' onmouseover='over_var=1;' onmouseout='over_var=0;'><#2685#></div>";
...
if(document.getElementById("" + _containerID + "_clientlist_dropdown_expand").innerText == "<#2685#>") {
...
{tag:"#CLIENTLIST_ELECTRONIC_DEVICES",text:"<#1498#>"},
{tag:"#CLIENTLIST_DESKTOP",text:"<#1499#>"},
{tag:"#CLIENTLIST_WINDOWS_DESKTOP",text:"<#1500#>"},
{tag:"#CLIENTLIST_LINUX_DESKTOP",text:"<#1501#>"},
{tag:"#CLIENTLIST_LINUX_DEVICE",text:"<#1502#>"},
{tag:"#CLIENTLIST_SMARTPHONE",text:"<#1503#>"},
{tag:"#CLIENTLIST_IPHONE",text:"<#1504#>"},
{tag:"#CLIENTLIST_ASUS_SMARTPHONE",text:"<#1505#>"},
{tag:"#CLIENTLIST_WINDOWS_PHONE",text:"<#1506#>"},
{tag:"#CLIENTLIST_ANDROID_PHONE",text:"<#1507#>"},
{tag:"#CLIENTLIST_PAD",text:"<#1508#>"},
{tag:"#CLIENTLIST_IPAD",text:"<#1509#>"},
{tag:"#CLIENTLIST_ASUS_PAD",text:"<#1510#>"},
{tag:"#CLIENTLIST_ANDROID_TABLET",text:"<#1511#>"},
{tag:"#CLIENTLIST_REPEATER",text:"<#1512#>"},
{tag:"#CLIENTLIST_NAS_SERVER",text:"<#1513#>"},
{tag:"#CLIENTLIST_NB",text:"<#1514#>"},
{tag:"#CLIENTLIST_WINDOWS_NB",text:"<#1515#>"},
{tag:"#CLIENTLIST_MACBOOK",text:"<#1516#>"},
{tag:"#Clientlist_ASUS_NB",text:"<#1517#>"},
{tag:"#CLIENTLIST_SD_CARD",text:"<#1518#>"},
{tag:"#CLIENTLIST_ROG_DEVICE",text:"<#1519#>"},
{tag:"#CLIENTLIST_SCANNER",text:"<#1520#>"},
{tag:"#CLIENTLIST_APPLE_DEVICE",text:"<#1521#>"},
{tag:"#CLIENTLIST_ANDROID_DEVICE",text:"<#1522#>"},
{tag:"#CLIENTLIST_WINDOWS_DEVICE",text:"<#1523#>"},
{tag:"#CLIENTLIST_ASUS_DEVICE",text:"<#1524#>"},
{tag:"#CLIENTLIST_MEDIA_ENTERTAINMENT",text:"<#1525#>"},
{tag:"#CLIENTLIST_ELECTRONIC_EQUIPMENT",text:"<#1526#>"},
{tag:"#CLIENTLIST_AIR_CONDITIONER",text:"<#1527#>"},
{tag:"#CLIENTLIST_REFRIGERATOR",text:"<#1528#>"},
{tag:"#CLIENTLIST_WEIGHT_SCALE",text:"<#1529#>"},
{tag:"#CLIENTLIST_ELECTRIC_POT",text:"<#1530#>"},
{tag:"#CLIENTLIST_MICROWAVE_OVEN",text:"<#1531#>"},
{tag:"#CLIENTLIST_AIR_PURIFIER",text:"<#1532#>"},
{tag:"#CLIENTLIST_FAN",text:"<#1533#>"},
{tag:"#CLIENTLIST_DEHUMIDIFIER",text:"<#1534#>"},
{tag:"#CLIENTLIST_WASHING_MACHINE",text:"<#1535#>"},
{tag:"#CLIENTLIST_WATER_HEATER",text:"<#1536#>"},
{tag:"#CLIENTLIST_ELECTRIC_KETTLE",text:"<#1537#>"},
{tag:"#CLIENTLIST_SMART_BULB",text:"<#1538#>"},
{tag:"#CLIENTLIST_SMART_TV",text:"<#1539#>"},
{tag:"#CLIENTLIST_CLEANING_ROBOT",text:"<#1540#>"},
{tag:"#CLIENTLIST_SECURITY",text:"<#1541#>"},
{tag:"#CLIENTLIST_SEISMOGRAPH",text:"<#1542#>"},
{tag:"#CLIENTLIST_SMART_LOCK",text:"<#1543#>"},
{tag:"#CLIENTLIST_WEARABLES",text:"<#1544#>"},
{tag:"#CLIENTLIST_SMART_BRACELET",text:"<#1545#>"},
{tag:"#CLIENTLIST_WATCH",text:"<#1546#>"},
{tag:"#CLIENTLIST_WALL_SWITCH",text:"<#1547#>"},
{tag:"#CLIENTLIST_WINDOW_SENSOR",text:"<#1548#>"},
{tag:"#CLIENTLIST_TEMPERATURE_HUMIDITY_SENSOR",text:"<#1549#>"},
{tag:"#CLIENTLIST_BODY_SENSOR",text:"<#1550#>"},
{tag:"#CLIENTLIST_SMART_PLUG",text:"<#1551#>"},
{tag:"#CLIENTLIST_ROBOT",text:"<#1552#>"},
{tag:"#PRINTER",text:"<#1491#>"},
{tag:"#ROUTER",text:"<#1666#>"},
{tag:"#NAS",text:"<#1668#>"},
{tag:"#IPCAM",text:"<#1669#>"}
];
...
$upload_category.append($("<div>").addClass("category_title").html("<#2693#>"));
