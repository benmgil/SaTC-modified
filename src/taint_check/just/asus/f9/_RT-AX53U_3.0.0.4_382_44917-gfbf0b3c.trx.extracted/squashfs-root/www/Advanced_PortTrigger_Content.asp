...
add_option(document.form.TriggerKnownApps, "<#713#>", "User Defined", 1);
...
<div class="formfontdesc"><#2269#></div>
<div class="formfontdesc" style="margin-top:-10px;">
<a id="faq" href="" target="_blank" style="font-family:Lucida Console;text-decoration:underline;"><#384#>&nbspFAQ</a>
</div>
<div class="formfontdesc" id="lb_note" style="color:#FFCC00; display:none;"><#2473#></div>
<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" class="FormTable">
<thead>
<tr>
<td colspan="6"><#3080#></td>
</tr>
</thead>
<tr>
<th colspan="2"><#2255#></th>
<td colspan="4">
<input type="radio" value="1" name="autofw_enable_x" class="content_input_fd" onClick="return change_common_radio(this, 'IPConnection', 'autofw_enable_x', '1')" <% nvram_match("autofw_enable_x", "1", "checked"); %>><#188#>
<input type="radio" value="0" name="autofw_enable_x" class="content_input_fd" onClick="return change_common_radio(this, 'IPConnection', 'autofw_enable_x', '0')" <% nvram_match("autofw_enable_x", "0", "checked"); %>><#187#>
</td>
</tr>
<tr>
<th colspan="2"align="right" id="autofw_rulelist"><#2272#></th>
<td colspan="4">
<select name="TriggerKnownApps" class="input_option" onChange="change_wizard(this);">
<option value="User Defined"><#713#></option>
</select>
</td>
</tr>
</table>
