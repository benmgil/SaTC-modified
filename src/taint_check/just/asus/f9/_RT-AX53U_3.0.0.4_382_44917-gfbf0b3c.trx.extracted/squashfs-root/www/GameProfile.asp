...
function initial(){
show_menu();
httpApi.faqURL("1045254", function(url){document.getElementById("faq").href=url;});
...
code += '<div class="table-content1-width"><div><#1197#></div></div>';
code += '<div class="table-content2-width"><div><#1487#></div></div>';
code += '<div class="table-content3-width"><div><#2278#></div></div>';
...
<div class="description-container"><#2107#></div>
<div class="description-container" style="color:#FFCC00;"><#2108#></div>
<div class="world-map">
...
<div class="control-description"><#2274#></div>
...
<div class="new-g-p-s-title"><#2090#></div>
</div>
...
<div class="new-g-p-s-title"><#2093#></div>
</div>
...
<div class="new-g-p-s-title"><#2946#></div>
</div>
<div class="new-p-platform">
<div id="name_field" class="game-p-s-field">
<div class="settings-filed-title"><#1464#></div>
...
<div class="settings-filed-title"><#2278#></div>
<div class="select-container">
<select name="" id="new_profile_protocol">
<option value="TCP">TCP</option>
<option value="UDP">UDP</option>
<option value="BOTH"><#2688#></option>
</select>
...
<div class="settings-filed-title"><#2288#></div>
...
<div class="settings-filed-title"><#2289#></div>
...
<div class="hint"><#1917#></div>
</div>
<div id="localIP_field" class="game-p-s-field" >
<div class="settings-filed-title"><#2290#></div>
...
<div class="settings-filed-title"><#2286#></div>
...
<div class="button-text"><#1615#></div>
</div>
</div>
...
<div class="new-g-p-title"><#2090#></div>
<div class="new-g-p-rule"><span id="rule_num">2</span> Rules (<#2484#> 32)</div>
</div>
<div id="list_content">
