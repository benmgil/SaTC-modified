...
htmlCode += '<div class="description_down"><#548#></div></td><td align="right"></td></tr></table></div>';
htmlCode += '<div style="margin:5px;" id="splitLine">';
htmlCode += '<div style="width: 720px; *width: 710px; height: 2px;" class="splitLine"></div></div>';
if(sw_mode_submit == "4"){
htmlCode += "<br><br><br><p style='font-size:20px;line-height: 25px;color:#FC0;' class='QISGeneralFont'>* <#442#> <#441#>";
htmlCode += "<br><br>* <#443#>";
htmlCode += "<br><br>* <#444#>";
}else{
htmlCode += "<br><br><br><p style='font-size:20px;line-height: 25px;color:#FC0;' class='QISGeneralFont'>* <#678#>";
htmlCode += "<br><br>* <#217#>";
}
if(sw_mode_submit == "2")
htmlCode += "<br><br>* <#444#></p>";
else
htmlCode += "</p>";
