...
if(<% check_acorpw(); %> == 1){
danger_count++;
document.getElementById('login_password').innerHTML = "<a href='Advanced_System_Content.asp' target='_blank'><#187#></a>";
...
safe_count++;
document.getElementById('login_password').innerHTML = "<#188#>";
...
if (nScore >= 0 && nScore < 20) { sComplexity = "<#460#>"; }
...
safe_count++;
document.getElementById('wireless_encryption').innerHTML = "<#463#>";
document.getElementById('wireless_encryption').className = "status_yes";
}
else{
danger_count++;
document.getElementById('wireless_encryption').innerHTML = "<a href='Advanced_Wireless_Content.asp' target='_blank'><#461#></a>";
...
if(wps_enable == 0){
safe_count++;
document.getElementById('wps_status').innerHTML = "<#188#>";
document.getElementById('wps_status').className = "status_yes";
}
else{
risk_count++;
document.getElementById('wps_status').innerHTML = "<a href='Advanced_WWPS_Content.asp' target='_blank'><#187#></a>";
...
safe_count++;
document.getElementById('upnp_service').innerHTML = "<#188#>";
document.getElementById('upnp_service').className = "status_yes";
}
else{
risk_count++
document.getElementById('upnp_service').innerHTML = "<a href='Advanced_WAN_Content.asp' target='_blank'><#187#></a>";
...
safe_count++;
document.getElementById('access_from_wan').innerHTML = "<#188#>";
document.getElementById('access_from_wan').className = "status_yes";
}
else{
risk_count++;
document.getElementById('access_from_wan').innerHTML = "<a href='Advanced_System_Content.asp' target='_blank'><#187#></a>";
...
safe_count++;
document.getElementById('ping_from_wan').innerHTML = "<#188#>";
document.getElementById('ping_from_wan').className = "status_yes";
}
else{
risk_count++;
document.getElementById('ping_from_wan').innerHTML = "<a href='Advanced_BasicFirewall_Content.asp' target='_blank'><#187#></a>";
...
if(document.form.dmz_ip.value == ""){
safe_count++;
document.getElementById('dmz_service').innerHTML = "<#188#>";
document.getElementById('dmz_service').className = "status_yes";
}
else{
risk_count++;
document.getElementById('dmz_service').innerHTML = "<a href='Advanced_Exposed_Content.asp' target='_blank'><#187#></a>";
...
safe_count++;
document.getElementById('port_tirgger').innerHTML = "<#188#>";
document.getElementById('port_tirgger').className = "status_yes";
}
else{
risk_count++;
document.getElementById('port_tirgger').innerHTML = "<a href='Advanced_PortTrigger_Content.asp' target='_blank'><#187#></a>";
...
safe_count++;
document.getElementById('port_forwarding').innerHTML = "<#188#>";
document.getElementById('port_forwarding').className = "status_yes";
}
else{
risk_count++;
document.getElementById('port_forwarding').innerHTML = "<a href='Advanced_VirtualServer_Content.asp' target='_blank'><#187#></a>";
...
if(ftp_account_mode == 1){
risk_count++;
document.getElementById('ftp_account').innerHTML = "<a href='Advanced_AiDisk_ftp.asp' target='_blank'><#187#></a>";
...
safe_count++;
document.getElementById('ftp_account').innerHTML = "<#188#>";
...
if(samba_account_mode == 1){
risk_count++;
document.getElementById('samba_account').innerHTML = "<a href='Advanced_AiDisk_samba.asp' target='_blank'><#187#></a>";
...
safe_count++;
document.getElementById('samba_account').innerHTML = "<#188#>";
...
safe_count++;
document.getElementById('wrs_service').innerHTML = "<#188#>";
document.getElementById('wrs_service').className = "status_yes";
}
else{
risk_count++;
document.getElementById('wrs_service').innerHTML = "<a href='AiProtection_HomeProtection.asp' target='_blank'><#187#></a>";
...
safe_count++;
document.getElementById('vp_service').innerHTML = "<#188#>";
document.getElementById('vp_service').className = "status_yes";
}
else{
risk_count++;
document.getElementById('vp_service').innerHTML = "<a href='AiProtection_HomeProtection.asp' target='_blank'><#187#></a>";
...
safe_count++;
document.getElementById('cc_service').innerHTML = "<#188#>";
document.getElementById('cc_service').className = "status_yes";
}
else{
risk_count++;
document.getElementById('cc_service').innerHTML = "<a href='AiProtection_HomeProtection.asp' target='_blank'><#187#></a>";
...
<tr>
<td>
<div class="weakness_router_status"><#1208#></div>
</td>
</tr>
<tr>
<td>
...
<tr>
<td>
<input class="button_gen" type="button" onclick="close_weakness_status();" value="<#1598#>">
</td>
<td>
<input id="all_security_btn" class="button_gen" type="button" onclick="enable_whole_security();" value="<#1623#>">
</td>
</tr>
</table>
</td>
...
<tr>
<th>
<div style="font-size:16px;"><#1156#></div>
</th>
</tr>
<td>
<div class="formfontdesc" style="font-size: 14px;"><#1204#></div>
</td>
<tr>
<td>
...
<input class="button_gen" type="button" onclick="close_alert_preference();" value="<#1598#>">
...
<tr>
<td align="left">
<span class="formfonttitle"><#1250#></span>
</td>
</tr>
</table>
</div>
...
<tr>
<td>
<div style="width:430px"><#1205#></div>
<div style="width:430px">
<a id="faq" style="text-decoration:underline;" href="" target="_blank"><#1250#> FAQ</a>
</div>
</td>
<td>
...
<div style="font-size:18px;text-shadow:1px 1px 0px black;"><#1208#></div>
<div style="font-size: 14px;color:#FC0;height:auto;padding-top:5px;"><#1209#></div>
</td>
<td width="6px">
...
<td style="width:20%;">
<div>
<input class="button_gen" type="button" onclick="showWeaknessTable();" value="<#1621#>">
</div>
</td>
<td>
<div class="line_vertical"></div>
...
<div>
<div style="font-size:18px;text-shadow:1px 1px 0px black;"><#1247#></div>
...
<div style="font-size: 16px;"><#1239#></div>
...
<div>
<div style="font-size:18px;text-shadow:1px 1px 0px black;"><#1266#></div>
<div style="font-size: 14px;color:#FC0;height:auto;padding-top:5px;"><#1267#></div>
</div>
</td>
<td width="6px">
<div class="line_vertical"></div>
...
<div style="font-size:18px;text-shadow:1px 1px 0px black;"><#1160#></div>
<div style="font-size: 14px;color:#FC0;height:auto;;padding-top:5px;"><#1159#></div>
</td>
<td>
<div class="line_vertical"></div>
</td>
...
<input class="button_gen" type="button" onclick="show_alert_preference();" value="<#1156#>">
</div>
</div>
