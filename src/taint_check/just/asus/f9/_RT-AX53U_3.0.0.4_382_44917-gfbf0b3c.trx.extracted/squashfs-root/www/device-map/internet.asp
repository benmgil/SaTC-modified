...
var Days = ~~(total / 24);
if (Days != 0)
value += Days.toString() + " <#1640#> ";
if (Hours != 0)
value += Hours.toString() + " <#2159#> ";
if (Minutes != 0)
value += Minutes.toString() + " <#2530#> ";
if (Seconds != 0)
value += Seconds.toString() + " <#2907#>";
return value;
}
function initial(){
if(parent.wans_flag){
...
if(gobi_support){
pri_if = (pri_if == "USB")? "<#2592#>" : pri_if;
sec_if = (sec_if == "USB")? "<#2592#>": sec_if;
if((unit == "0" && pri_if == "<#2592#>") || (unit == "1" && sec_if == "<#2592#>"))
...
showtext(document.getElementById("dualwan_mode"), "<#1786#>");
loadBalance_form(unit);
}
else{
showtext(document.getElementById("dualwan_mode"), "<#1785#>");
...
if(lanproto == "static")
showtext(document.getElementById("LanProto"), "<#169#>");
else
...
<div class="formfonttitle_nwm" style="width:80%; margin-bottom: 0px;" id="wan_enable_title"><#383#></div>
...
<td height="50" style="padding:10px 15px 0px 15px;">
<div style="display:flex; align-items:center; justify-content:space-between;">
<div class="formfonttitle_nwm" style="width:80%; margin-bottom: 0px;"><#1771#></div>
...
<p class="formfonttitle_nwm"><#3484#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#3482#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#1784#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#1787#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm" ><#193#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#3471#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#3739#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2879#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2390#></p>
...
<input type="button" class="button_gen" onclick="goToDualWAN();" value="<#1476#>" style="position:absolute;right:25px;margin-top:-10px;margin-left:115px;">
...
<p class="formfonttitle_nwm" style="float:left;width:116px;"><#1479#></p>
<input type="button" class="button_gen" onclick="goToWAN();" value="<#1476#>" style="position:absolute;right:25px;margin-top:-10px;margin-left:115px;">
</td>
</tr>
</table>
...
<p class="formfonttitle_nwm"><#730#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2374#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#303#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2166#></p>
...
<input type="button" class="button_gen" onclick="gotoSiteSurvey();" value="<#590#>" style="float:right;margin: 5px 0;">
</td>
</tr>
</table>
</form>
