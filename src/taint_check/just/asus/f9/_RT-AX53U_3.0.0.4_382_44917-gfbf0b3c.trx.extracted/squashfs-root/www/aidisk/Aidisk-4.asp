...
case "0":
showtext(document.getElementById("dummyShareStr"), "\"<#3032#>\"");
break;
case "1":
showtext(document.getElementById("dummyShareStr"), "\"<#3033#>\"");
break;
case "2":
showtext(document.getElementById("dummyShareStr"), "\"<#3034#>\"");
break;
}
}
...
<tr>
<td align="left" class="formfonttitle" style="padding-left:20px;" height="72"><#3035#></td>
</tr>
<tr>
...
<input type="button" id="finish" value="<#1606#>" class="button_gen">
</div>
</td>
</tr>
</table>
