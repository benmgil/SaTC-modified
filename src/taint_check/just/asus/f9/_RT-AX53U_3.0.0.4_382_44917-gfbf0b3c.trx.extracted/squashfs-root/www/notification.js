...
notification.desc[12] = "<#2549#>";
notification.action_desc[12] = "<#1378#>";
...
notification.acpw = 1;
notification.desc[0] = '<#1371#>';
notification.action_desc[0] = '<#1378#>';
...
notification.desc[1] = '<#1372#>';
notification.action_desc[1] = '<#1379#>';
...
notification.action_desc[1] = '<a id="link_to_downlodpage" target="_blank" href="'+get_helplink()+'" style="color:#FFCC00;"><#1379#></a>';
...
notification.desc[2] = '<#1373#>';
notification.action_desc[2] = '<#1378#> (2.4GHz)';
...
notification.desc[3] = '<#1373#>';
if(band5g2_support)
notification.action_desc[3] = '<#1378#> (5GHz-1)';
else
notification.action_desc[3] = '<#1378#> (5GHz)';
...
notification.desc[19] = '<#1373#>';
notification.action_desc[19] = '<#1378#> (5GHz-2)';
...
notification.ftp = 1;
notification.desc[4] = '<#1375#>';
notification.action_desc[4] = '<#809#>';
...
notification.array[4] = 'noti_ftp';
notification.ftp = 1;
notification.desc[4] = '<#1374#>';
notification.action_desc[4] = '<#1378#>';
notification.clickCallBack[4] = "showLoading();setTimeout('document.noti_ftp.submit();', 1);setTimeout('notification.redirectftp()', 2000);";
}else
notification.ftp = 0;
...
notification.desc[5] = '<#1377#>';
notification.action_desc[5] = '<#809#>';
...
notification.array[5] = 'noti_samba';
notification.samba = 1;
notification.desc[5] = '<#1376#>';
notification.action_desc[5] = '<#1378#>';
notification.clickCallBack[5] = "showLoading();setTimeout('document.noti_samba.submit();', 1);setTimeout('notification.redirectsamba()', 2000);";
}else
...
notification.action_desc[8] = "<#1615#>";
...
notification.desc[15] = '<#3757#>';
notification.action_desc[15] = '<#3758#>';
