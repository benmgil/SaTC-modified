...
document.getElementById("loginMethod").innerHTML = "<#956#>";
document.getElementById("accountMask").style.display = "none";
}
else{
document.getElementById("loginMethod").innerHTML = "<#955#>";
...
document.getElementById("createAccountBtn").onmouseover = function(){};
document.getElementById("createAccountBtn").onmouseout = function(){};
document.getElementById("createAccountBtn").title = (accounts.length < 6)?"<#895#>":"<#862#>";
}
...
<span class="formfonttitle"><#388#> - <#389#><span id="clouddiskstr"> / <#1554#></span></span>
...
<div class="formfontdesc" style="margin-top: 10px;"><#2902#></div>
<div class="formfontdesc"><#905#>&nbsp;<#2903#></div>
</td>
</tr>
<tr>
<td>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(17,2);"><#2951#></a>
</th>
<td>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(17,3);"><#2964#></a>
</th>
<td>
...
<option class="content_input_fd" value="0" <% nvram_match("usb_fs_ntfs_sparse", "0","selected"); %>><#3604#></option>
<option class="content_input_fd" value="1" <% nvram_match("usb_fs_ntfs_sparse", "1","selected"); %>><#3603#></option>
</select>
</td>
</tr>
</table>
