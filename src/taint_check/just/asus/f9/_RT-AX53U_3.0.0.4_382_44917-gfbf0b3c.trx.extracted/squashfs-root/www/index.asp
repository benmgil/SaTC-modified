...
html += '</a>';
html += '<div class="clients" id="ameshNumber" style="cursor:pointer;"><#1019#>: <span>0</span></div>';
...
document.getElementById('NM_connect_title').innerHTML = "<#2695#> :";
}
else{
...
document.getElementById("first_wan_title").innerHTML = "<#1834#>:";
...
if(gobi_support)
document.getElementById("first_wan_title").innerHTML = "<#2592#>:";
else
document.getElementById("first_wan_title").innerHTML = "<#392#>:";
}
if(dualwan_second_if == 'wan')
document.getElementById("second_wan_title").innerHTML = "<#1834#>:";
...
if(gobi_support)
document.getElementById("second_wan_title").innerHTML = "<#2592#>:";
else
document.getElementById("second_wan_title").innerHTML = "<#392#>:";
}
}
...
if( ddns_enable == '0')
document.getElementById("ddnsHostName").innerHTML = '<a style="color:#FFF;text-decoration:underline;" href="/Advanced_ASUSDDNS_Content.asp?af=ddns_enable_x"><#1476#></a>';
else if(ddnsName == '')
document.getElementById("ddnsHostName").innerHTML = '<a style="color:#FFF;text-decoration:underline;" href="/Advanced_ASUSDDNS_Content.asp?af=DDNSName"><#2969#></a>';
...
if(sw_mode == "3"){
showtext(document.getElementById("NM_connect_status"), "<div style='margin-top:10px;'><#3614#></div>");
}
else if(sw_mode == "2"){
showtext(document.getElementById("NM_connect_title"), "<div style='margin-top:10px;'><#730#>:</div><br>");
}
else
return 0;
}
...
document.getElementById("clientNumber").innerHTML = "<#2047#>: <span id='_clientNumber'>" + num + "</span>";
}
...
dec_html_code += '<div class="style1"><strong id="diskUnmount'+ device.usbPath +'"><#1684#></strong></div>\n';
}
...
document.getElementById("deviceDec_" + device.usbPath).innerHTML = '<div style="margin:10px;"><#1605#></div>';
else
document.getElementById("deviceDec_" + device.usbPath).innerHTML = '<div style="margin:10px;"><#1602#></div>';
}
...
document.getElementById("changeIconTitle").innerHTML = "<#1598#>";
}
else {
$(".custom_icon_list_bg").slideUp("slow");
document.getElementById("changeIconTitle").innerHTML = "<#1595#>";
}
}
...
if(bwdpi_support) {
document.getElementById("time_scheduling_title").innerHTML = "<#3085#>";
}
...
connectModeTip += "<#859#>: " + clientObj.wlConnectTime + "";
}
}
if(sw_mode != 4){
...
document.getElementById('client_login').innerHTML = "<#1490#>";
}
if(clientObj.isPrinter) {
document.getElementById('client_printer').style.display = "";
document.getElementById('client_printer').innerHTML = "<#1491#>";
}
...
<div style="margin:200px auto; width:300px; background-color:#006699; color:#FFFFFF; line-height:150%; border:3px solid #FFF; padding:5px;"><#420#></p></div>
</div>
</noscript>
...
<thead>
<tr>
<td colspan="4">Client upload icon&nbsp;(<#2484#>&nbsp;100)</td>
</tr>
</thead>
<tr>
<th width="45%"><#1484#></th>
...
<input class="button_gen" type="button" onclick="btUserIconEdit();" value="<#1615#>">
...
<span title="Change to default client icon" class="IE8HACK" onclick="setDefaultIcon();"><#1601#></span>
<span id="changeIconTitle" class="IE8HACK" title="Change client icon" style="margin-left:10px;" onclick="show_custom_image();"><#1595#></span>
</div>
</td>
...
<span onmouseover="return overlib('Enable this button to block this device to access internet.');" onmouseout="return nd();"><#1486#></span></div>
<div class="left" style="cursor:pointer;float:right;" id="radio_BlockInternet_enable"></div>
</div>
<div class="clientList_line"></div>
<div style="height:32px;width:100%;margin:5px 0;">
<div style="width:65%;float:left;line-height:32px;">
<span id="time_scheduling_title" onmouseover='return overlib("<#2704#>");' onmouseout="return nd();"><#457#></span>
</div>
<div align="center" class="left" style="cursor:pointer;float:right;" id="radio_TimeScheduling_enable"></div>
<div id="internetTimeScheduling" class="internetTimeEdit" style="float:right;margin-right:10px;" title="<#3085#>" onclick="redirectTimeScheduling(document.getElementById('macaddr_field').value);" ></div>
</div>
<div class="clientList_line"></div>
<div style="height:32px;width:100%;margin:5px 0;">
<div style="width:65%;float:left;line-height:32px;">
<span onmouseover="return overlib('Enable this button to bind specific IP with MAC Address of this device.');" onmouseout="return nd();"><#1488#></span></div>
...
<input class="button_gen" type="button" onclick="edit_delete();" id="deleteBtn" value="<#1599#>" style="display:none;">
<input class="button_gen" type="button" id="blockBtn" value="<#1401#>" title="<#1448#>" style="display:none;">
<script>
...
<div id="first_wan_title"><#1802#>:</div>
...
<div id="second_wan_title"><#1809#>:</div>
...
<div>
<span id="NM_connect_title" style="font-size:12px;font-family: Verdana, Arial, Helvetica, sans-serif;"><#3023#>:</span>
<br>
<strong id="NM_connect_status" class="index_status" style="font-size:14px;"><#620#>...</strong>
</div>
...
<strong id="ddnsHostName" class="index_status" style="font-size:14px;"><#511#></strong>
...
<span style="font-size:14px;font-family: Verdana, Arial, Helvetica, sans-serif;"><#2203#>:</span>
...
<span style="font-size:14px;font-family: Verdana, Arial, Helvetica, sans-serif;"><#2908#>: </span>
<br/>
<strong id="wl_securitylevel_span" class="index_status"></strong>
<img id="iflock">
</div>
<div id="mbModeContext" style="display:none">
<span style="font-size:14px;font-family: Verdana, Arial, Helvetica, sans-serif;"><#400#>: </span>
<br/>
<br/>
<strong class="index_status"><#435#></strong>
</div>
</td>
</tr>
<tr>
...
<input type="button" class="button_gen" value="<#3305#>" style="margin-top:15px;" onClick="pop_clientlist_listview(true)">
