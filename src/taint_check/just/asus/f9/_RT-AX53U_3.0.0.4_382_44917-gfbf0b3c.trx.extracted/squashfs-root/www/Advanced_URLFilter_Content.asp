...
<div class="formfontdesc"><#2003#></div>
<!--div class="formfontdesc"><#1972#></div-->
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(9,1);"><#2002#></th>
<td>
<input type="radio" value="1" name="url_enable_x" <% nvram_match("url_enable_x", "1", "checked"); %>><#1605#>
<input type="radio" value="0" name="url_enable_x" <% nvram_match("url_enable_x", "0", "checked"); %>><#1602#>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(9,3);"><#1979#></a></th>
<td>
<select name="url_mode_x" class="input_option" onChange="">
<option class="content_input_fd" value="0" <% nvram_match( "url_mode_x", "0", "selected"); %>><#1400#></option>
<option class="content_input_fd" value="1" <% nvram_match( "url_mode_x", "1", "selected"); %>><#3516#></option>
</select>
</td>
</tr>
</table>
