...
code += mals_count;
code += '<span style="font-size: 16px;padding-left: 5px;"><#1239#></span>';
...
if(code == ''){
code += '<div style="font-size:16px;text-align:center;margin-top:70px;color:#FC0"><#1172#></div>';
}
...
code += '<div style="display:table-cell;width:180px;padding-right:5px;"><#1705#></div>';
code += '<div style="display:table-cell;width:80px;padding-right:5px;"><#1170#></div>';
code += '<div style="display:table-cell;width:170px;padding-right:5px;"><#1169#></div>';
code += '<div style="display:table-cell;width:200px;padding-right:5px;"><#1168#></div>';
code += '<div style="display:table-cell;width:50px;padding-right:5px;"></div>';
code += '</div>';
if(dataObj == ""){
code += '<div style="text-align:center;font-size:16px;color:#FC0;margin-top:90px;"><#2285#></div>';
}
else{
...
code += '<div style="display:table-cell;width:200px;height:30px;vertical-align:middle;padding-right:5px;text-decoration:underline;cursor:pointer;" title="<#1279#>" onclick="checkEventSafe(\''+ dataObj[eventID].destination[0] +'\');">'+ dataObj[eventID].destination[0] +'</div>';
...
<tr>
<td align="left">
<span class="formfonttitle"><#1250#> - <#1247#></span>
</td>
</tr>
</table>
</div>
...
<div style="font-size:16px;margin:0 0 5px 5px;text-align:center"><#1166#></div>
</div>
...
<div style="text-align:center;font-size:16px;"><#1265#></div>
...
<div style="font-size:16px;margin:0 0 5px 5px;text-align:center;"><#1154#></div>
...
<div>
<div style="display:inline-block;margin:5px 10px"><#1239#></div>
</div>
<div style="width:90%">
<div>
...
<div style="text-align:center;font-size:16px;"><#1171#></div>
<div style="display: flex;">
<div style="margin: 0 8px;"><div id="save_icon" class="icon-container icon-save" title="<#1616#>" onclick="download(csvContent, 'MaliciousSitesBlocking.csv', 'data:text/csv;charset=utf-8');"></div></div>
<div style="margin: 0 8px;"><div id="delete_icon" class="icon-container icon-delete" onclick="showEraseConfirm();" title="<#1599#>"></div></div>
...
<div style="font-size: 24px;"><#3516#></div>
<div onclick="hideWhitelistField();"><img src="images/New_ui/icon_close.svg" alt="" style="width:32px;height:32px;cursor:pointer;"></div>
</div>
<div style="color: #CCCCCC;font-size: 16px;margin: 12px 0 24px 0;"><#1248#></div>
<div>
<div style="font-size: 14px;padding: 0 0 2px 4px;"><#1249#></div>
<div>
...
<input type="button" class="button_gen" value="<#1593#>" onclick="addWhitelist();">
</div>
<div style="width:100%;" class="line_horizontal"></div>
<div style="margin-top:24px;">
<span style="font-size: 24px;padding-right:12px;"><#3516#></span>
<span style="font-size: 14px;"><#2653#>: <b id="list_count">0</b> (<#2484#>&nbsp;64)</span>
</div>
...
<div style="display:table-cell;width:180px;padding-right:5px;"><#1705#></div>
<div style="display:table-cell;width:80px;padding-right:5px;"><#1170#></div>
<div style="display:table-cell;width:170px;padding-right:5px;"><#1169#></div>
<div style="display:table-cell;width:200px;padding-right:5px;"><#1168#></div>
