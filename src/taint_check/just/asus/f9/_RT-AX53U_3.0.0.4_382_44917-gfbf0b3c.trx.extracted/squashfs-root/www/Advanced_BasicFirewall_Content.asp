...
add_option(document.form.KnownApps, "<#713#>", 0, 1);
...
code +='<tr><td style="color:#FFCC00;" colspan="6"><#2285#></td></tr>';
else{
...
<div>&nbsp;</div>
<div class="formfonttitle"><#393#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc" style="font-size:14px;font-weight:bold;margin-top:10px;"><#372#></div>
<div class="formfontdesc"><#1959#></div>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(8,6);"><#1966#></a></th>
<td>
<input type="radio" value="1" name="fw_enable_x" onClick="return change_common_radio(this, 'FirewallConfig', 'fw_enable_x', '1')" <% nvram_match("fw_enable_x", "1", "checked"); %>><#188#>
<input type="radio" value="0" name="fw_enable_x" onClick="return change_common_radio(this, 'FirewallConfig', 'fw_enable_x', '0')" <% nvram_match("fw_enable_x", "0", "checked"); %>><#187#>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(8,7);"><#1964#></a></th>
<td>
<input type="radio" value="1" name="fw_dos_x" class="input" onClick="return change_common_radio(this, 'FirewallConfig', 'fw_dos_x', '1')" <% nvram_match("fw_dos_x", "1", "checked"); %>><#188#>
<input type="radio" value="0" name="fw_dos_x" class="input" onClick="return change_common_radio(this, 'FirewallConfig', 'fw_dos_x', '0')" <% nvram_match("fw_dos_x", "0", "checked"); %>><#187#>
</td>
</tr>
<tr>
<th align="right"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(8,1);"><#2006#></a></th>
<td>
<select name="fw_log_x" class="input_option">
<option value="none" <% nvram_match("fw_log_x", "none","selected"); %>><#833#></option>
<option value="drop" <% nvram_match("fw_log_x", "drop","selected"); %>><#2690#></option>
<option value="accept" <% nvram_match("fw_log_x", "accept","selected"); %>><#2687#></option>
<option value="both" <% nvram_match("fw_log_x", "both","selected"); %>><#2688#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(8,5);"><#2010#></a></th>
<td>
<input type="radio" value="1" name="misc_ping_x" class="input" onClick="return change_common_radio(this, 'FirewallConfig', 'misc_ping_x', '1')" <% nvram_match("misc_ping_x", "1", "checked"); %>><#188#>
<input type="radio" value="0" name="misc_ping_x" class="input" onClick="return change_common_radio(this, 'FirewallConfig', 'misc_ping_x', '0')" <% nvram_match("misc_ping_x", "0", "checked"); %>><#187#>
</td>
</tr>
...
<div class="formfontdesc" style="font-size:14px;font-weight:bold;margin-top:10px;"><#1968#></div>
...
<th><#1967#></th>
<td>
<input type="radio" value="1" name="fw_wl_enable_x" <% nvram_match("fw_wl_enable_x", "1", "checked"); %>><#188#>
<input type="radio" value="0" name="fw_wl_enable_x" <% nvram_match("fw_wl_enable_x", "0", "checked"); %>><#187#>
</td>
</tr>
</table>
...
<thead>
<tr>
<td colspan="7"><#2019#>&nbsp;(<#2484#>&nbsp;128)</td>
</tr>
</thead>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,25);"><#1985#></a></th>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,24);"><#1986#></a></th>
<th><#2278#></th>
<th><#2483#></th>
</tr>
<tr>
...
<div class="formfontdesc" style="font-size:14px;font-weight:bold;margin-top:10px;"><#398#></div>
<div>
<div class="formfontdesc"><#2017#></div>
<div class="formfontdesc"><#2018#></div>
</div>
<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" class="FormTable">
<thead>
<tr>
...
<th><#2016#></th>
<td>
<input type="radio" value="1" name="ipv6_fw_enable" <% nvram_match("ipv6_fw_enable", "1", "checked"); %>><#188#>
<input type="radio" value="0" name="ipv6_fw_enable" <% nvram_match("ipv6_fw_enable", "0", "checked"); %>><#187#>
</td>
</tr>
<tr>
<th><#2284#></th>
...
<th><#1464#></th>
<th><#2020#></th>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,25);"><#2276#></a></th>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,24);"><#1986#></a></th>
<th><#2278#></th>
<th><#2483#></th>
</tr>
