...
<link rel="icon" href="images/favicon.png"><title><#828#> - <#766#></title>
...
<table><tr><td>
<div class="machineName" style="width:200px;font-family:Microsoft JhengHei;font-size:12pt;font-weight:bolder; margin-top:15px;margin-left:30px;"><#829#></div>
</td>
<td>
<div style="width:240px;margin-top:14px;margin-left:135px;">
<table >
<tr>
<td><div id="createFolderBtn" class="createFolderBtn" title="<#897#>"></div></td>
<td><div id="deleteFolderBtn" class="deleteFolderBtn" title="<#1659#>"></div></td>
<td><div id="modifyFolderBtn" class="modifyFolderBtn" title="<#2610#>"></div></td>
</tr>
</table>
</div>
</td></tr></table>
...
<input class="button_gen" type="button" onclick="confirm_folderTree();" value="<#1615#>">
</div>
</div>
...
<span class="formfonttitle"><#766#></span>
<span id="returnBtn">
<img id="returnBtn" onclick="go_setting('/APP_Installation.asp')" align="right" title="<#368#>" src="/images/backprev.png" onMouseOver="this.src='/images/backprevclick.png'" onMouseOut="this.src='/images/backprev.png'">
</span>
</div>
<div id="splitLine" class="splitLine"></div>
<div id="upnp_desc_id" class="formfontdesc" style="margin-top: 10px;"><#3252#></div>
</td>
</tr>
<tr>
<td>
...
<div id="noUSB" style="color:#FC0;display:none;margin-left:17px;padding-top:2px;padding-bottom:2px;"><#2672#></div>
</td>
</tr>
<tr>
<th><#1716#></th>
...
<th><#1718#></th>
<td>
<input type="radio" value="0" name="dms_dir_manual_x" class="input" onClick="set_dms_dir(this);" <% nvram_match("dms_dir_manual", "0", "checked"); %>><#1719#>
<input type="radio" value="1" name="dms_dir_manual_x" class="input" onClick="set_dms_dir(this);" <% nvram_match("dms_dir_manual", "1", "checked"); %>><#1717#>
</td>
</tr>
</table>
</div>
...
<thead>
<tr>
<td colspan="3" id="GWStatic"><#1717#>&nbsp;(<#2484#>&nbsp;10)</td>
</tr>
</thead>
<tr>
<th><#1714#></th>
...
<tr>
<td width="45%">
<input id="PATH" type="text" class="input_30_table" value="" onclick="get_disk_tree();" autocorrect="off" autocapitalize="off" readonly="readonly"/" placeholder="<#713#>" >
</td>
<td width="40%">
