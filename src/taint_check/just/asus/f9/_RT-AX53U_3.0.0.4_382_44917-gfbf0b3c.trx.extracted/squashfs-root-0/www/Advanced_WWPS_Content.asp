...
loadXML();
document.getElementById('WPS_hideSSID_hint').innerHTML = "<#2057#> <#3729#>";
...
document.getElementById("wps_band_hint").innerHTML = "* <#3705#>";
return false;
}
...
if(wps_enable_old == "1"){
document.getElementById("wps_enable_word").innerHTML = "<#1474#>";
document.getElementById("enableWPSbtn").value = "<#1472#>";
...
document.getElementById("wps_enable_word").innerHTML = "<#1473#>"
document.getElementById("enableWPSbtn").value = "<#3603#>";
...
document.getElementById("wps_enable_hint").innerHTML = "* <#2677#> <a style='color:#FC0; text-decoration: underline; font-family:Lucida Console;cursor:pointer;' onclick=\"_change_wl_advanced_unit_status(" + htmlEnDeCode.htmlEncode(wps_infos[12].firstChild.nodeValue) + ");\"><#1476#></a>"
controlDisplayItem();
return;
}
...
document.getElementById("wps_enable_hint").innerHTML = "<#3732#><br><#3733#> <a style='color:#FC0; text-decoration: underline; font-family:Lucida Console;cursor:pointer;' onclick=\"_change_wl_unit_status(" + htmlEnDeCode.htmlEncode(wps_infos[12].firstChild.nodeValue) + ");\"><#372#></a> <#3734#>"
controlDisplayItem();
return;
}
if(wps_enable_old == "0"){
document.getElementById("wps_state_tr").style.display = "";
document.getElementById("wps_state_td").innerHTML = "<#3731#>";
...
document.getElementById("wps_config_td").innerHTML = "<#1473#>";
else
document.getElementById("wps_config_td").innerHTML = "<#1474#>";
}
...
if(radio_2 !== "1") {
band_link += " <a style='color:#FC0; text-decoration: underline; font-family:Lucida Console;cursor:pointer;' onclick=\"_change_wl_advanced_unit_status(0);\"><#1476#> " + get_band_str(wps_infos0[12].firstChild.nodeValue) + "</a>"
}
if(radio_5 !== "1") {
band_link += " <a style='color:#FC0; text-decoration: underline; font-family:Lucida Console;cursor:pointer;' onclick=\"_change_wl_advanced_unit_status(1);\"><#1476#> " + get_band_str(wps_infos1[12].firstChild.nodeValue) + "</a>"
}
document.getElementById("wps_enable_hint").innerHTML = "* <#2677#>" + band_link + "";
...
if(rej0)
band_link += "<a style='color:#FC0; text-decoration: underline; font-family:Lucida Console;cursor:pointer;' onclick=\"_change_wl_unit_status(0);\"><#372#> " + get_band_str(wps_infos0[12].firstChild.nodeValue) + "</a> ";
if(rej1)
band_link += "<a style='color:#FC0; text-decoration: underline; font-family:Lucida Console;cursor:pointer;' onclick=\"_change_wl_unit_status(1);\"><#372#> " + get_band_str(wps_infos1[12].firstChild.nodeValue) + "</a> ";
document.getElementById("wps_enable_hint").innerHTML = "<#3732#><br><#3733#> " + band_link + " <#3734#>";
if (rej0 && rej1){
document.getElementById("wps_state_tr").style.display = "none";
document.getElementById("devicePIN_tr").style.display = "none";
document.getElementById("wpsmethod_tr").style.display = "none";
...
document.getElementById("wps_state_td").innerHTML = "<#3731#> / <#3731#>";
document.getElementById("WPSConnTble").style.display = "none";
document.getElementById("wpsDesc").style.display = "none";
}
else{
...
<div>&nbsp;</div>
<div class="formfonttitle"><#371#> - <#373#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#3570#></div>
...
<tr>
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(13,1);"><#3703#></a></th>
<td>
...
<tr id="wps_band_tr">
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onclick="openHint(13,5);"><#1628#></th>
<td id="wps_switch">
<span class="devicepin" style="color:#FFF;" id="wps_band_word"></span>&nbsp;&nbsp;
<input type="button" class="button_gen" name="switchWPSbtn" id="switchWPSbtn" value="<#3038#>" class="button" onClick="SwitchBand();">
...
<td style="border:0px">
<input class="button_gen" type="button" onClick="resetWPS();" id="Reset_OOB" name="Reset_OOB" value="<#1619#>" style="padding:0 0.3em 0 0.3em;" >
<br><span id="Reset_OOB_desc"><#3688#></span>
</td>
</tr></table>
</div>
</td>
...
<tr id="devicePIN_tr">
<th>
<span id="devicePIN_name"><a class="hintstyle" href="javascript:void(0);" onclick="openHint(13,4);"><#3633#></a></span>
</th>
<td>
...
<tr id="wpsmethod_tr">
<th>
<span id="wps_method"><a class="hintstyle" href="javascript:void(0);" onclick="openHint(13,2);"><#3709#></a></span>
</th>
<td>
<input type="radio" name="wps_method" onclick="changemethod(0);" value="0"><#3704#>
<input type="radio" name="wps_method" onclick="changemethod(1);" value="1"><#3711#>
...
<div id="starBtn" style="margin-top:10px;"><input class="button_gen" type="button" style="margin-left:5px;" onClick="configCommand();" id="addEnrolleebtn_client" name="addEnrolleebtn" value="<#3730#>"></div>
</td>
</tr>
</table>
</td>
