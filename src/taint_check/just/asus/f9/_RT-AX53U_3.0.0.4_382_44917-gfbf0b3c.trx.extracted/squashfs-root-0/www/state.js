...
var is_S2_sku = in_territory_code("S2");
...
if(isMobile() && (based_modelid == "RT-AC88U" || based_modelid == "RT-AX8U" || based_modelid == "RT-AC86U" || based_modelid == "GT-AC2900" || based_modelid == "RT-AC3100" || based_modelid == "RT-AC5300" || based_modelid == "GT-AC5300" || based_modelid == "GT-AC9600" || based_modelid == "GT-AX11000" || based_modelid == "GT-AXE11000" || based_modelid == "GT-AX11000_PRO"))
...
banner_code +='<div style="margin-top:0px;margin-left:-90px;*margin-top:0px;*margin-left:0px;" align="center"><span id="modelName_top" onclick="this.focus();" class="modelName_top" style="margin:7px 0 0 5px;"><#829#></span></div>';
banner_code +='<a href="javascript:logout();"><div style="margin:20px 0 0 10px;*width:136px;background:url(\'images/New_ui/btn_logout.png\') no-repeat;background-size:cover;width:132px;height:34px;float:left;" align="center"><div style="margin:8px 0 0 15px;"><#745#></div></div></a>\n';
}
else{
banner_code +='<div style="margin-top:0px;margin-left:-90px;*margin-top:0px;*margin-left:0px;" align="center"><span id="modelName_top" onclick="this.focus();" class="modelName_top"><#829#></span></div>';
banner_code +='<a href="javascript:logout();"><div style="margin:20px 0 0 15px;*width:136px;background:url(\'images/New_ui/btn_logout.png\') no-repeat;background-size:cover;width:132px;height:34px;float:left;" align="center"><div style="margin:8px 0 0 15px;"><#745#></div></div></a>\n';
}
}
else if(tuf_support){
...
banner_code +='<a href="javascript:logout();"><div style="margin-top:13px;margin-left:125px; *width:136px;" class="titlebtn" align="center"><span><#745#></span></div></a>\n';
banner_code +='<a href="javascript:reboot();"><div style="margin-top:13px;margin-left:0px;*width:136px;" class="titlebtn" align="center"><span><#180#></span></div></a>\n';
}
else{
banner_code +='<div class="banner1" align="center"><img src="images/New_ui/asustitle.png" width="218" height="54" align="left">\n';
banner_code +='<div style="margin-top:13px;margin-left:-90px;*margin-top:0px;*margin-left:0px;" align="center"><span id="modelName_top" onclick="this.focus();" class="modelName_top"><#829#></span></div>';
banner_code +='<a href="javascript:logout();"><div style="margin-top:13px;margin-left:25px; *width:136px;" class="titlebtn" align="center"><span><#745#></span></div></a>\n';
banner_code +='<a href="javascript:reboot();"><div style="margin-top:13px;margin-left:0px;*width:136px;" class="titlebtn" align="center"><span><#180#></span></div></a>\n';
}
...
banner_code += '<div style="font-size: 14px;margin-left:12px;"><#3986#></div>';
...
banner_code +='<span style="font-family:Verdana, Arial, Helvetica, sans-serif;"><#401#>:</sapn><span class="title_link" style="text-decoration: none;" id="op_link"><a href="/Advanced_OperationMode_Content.asp" style="color:white"><span id="sw_mode_span" style="text-decoration: underline;"></span></a></span>\n';
}
...
banner_code +='<div style="padding:5px 0 5px 15px;font-size:14px;color:#BDBDBD"><#1368#></div>';
banner_code +='</div>';
banner_code +='</div>';
...
banner_code += "<#2549#>";
banner_code +='</div>';
banner_code +="<span><input style=\"margin-left:30px;\" type=\"checkbox\" name=\"stop_show_chk\" id=\"stop_show_chk\"><#2590#></input></span>";
...
footer_code += '<td width="20" align="right"><div id="bottom_help_icon" style="margin-right:3px;"></div></td><td width="110" id="bottom_help_title" align="left"><#2150#> & <#3037#></td>';
var tracing_path_Manual = "/HelpDesk_Manual/?utm_source=asus-product&utm_medium=referral&utm_campaign=router";
var model_name_supportsite = supportsite_model(support_site_modelid, hw_ver); // @ /js/support_site.js
footer_code += "<td width=\"335\" id=\"bottom_help_link\" align=\"left\"><a style=\"font-weight: bolder;text-decoration:underline;cursor:pointer;\" href=\"https://www.asus.com"+ href_lang +"Networking/"+ model_name_supportsite + tracing_path_Manual +"\" target=\"_blank\"><#2499#></a>";
footer_code += "&nbsp|&nbsp<a id=\"registration_link\" target=\"_blank\" href=\""+ href_reg_url +"\" target=\"_self\" style=\"font-weight: bolder;text-decoration:underline;cursor:pointer;\"><#2813#></a>";
if(dsl_support && frs_feedback_support){
if(isSupport("is_ax5400_i1"))
footer_code += '';
else
footer_code += '&nbsp|&nbsp<a id="fb_link" href="/Advanced_Feedback.asp" target="_self" style="font-weight: bolder;text-decoration:underline;cursor:pointer;"><#2519#></a>';
}
...
footer_code += '&nbsp|&nbsp<a id="fb_link" href="'+location_href+'" target="_self" style="font-weight: bolder;text-decoration:underline;cursor:pointer;"><#2519#></a>';
}
footer_code += '</td>';
...
var faqLang = {
EN : "https://account.asus.com/loginform.aspx?lang=en-us",
TW : "https://account.asus.com/loginform.aspx?lang=zh-tw",
CN : "https://account.asus.com.cn/loginform.aspx",
BR : "https://account.asus.com/loginform.aspx?lang=pt-br",
CZ : "https://account.asus.com/loginform.aspx?lang=cs-cz",
DA : "https://account.asus.com/loginform.aspx?lang=da-dk",
DE : "https://account.asus.com/loginform.aspx?lang=de-de",
ES : "https://account.asus.com/loginform.aspx?lang=es-es",
FI : "https://account.asus.com/loginform.aspx?lang=fi-fi",
FR : "https://account.asus.com/loginform.aspx?lang=fr-fr",
HU : "https://account.asus.com/loginform.aspx?lang=hu-hu",
IT : "https://account.asus.com/loginform.aspx?lang=it-it",
JP : "https://account.asus.com/loginform.aspx?lang=ja-jp",
KR : "https://account.asus.com/loginform.aspx?lang=ko-kr",
MS : "https://account.asus.com/loginform.aspx?lang=ms-my",
NL : "https://account.asus.com/loginform.aspx?lang=nl-nl",
NO : "https://account.asus.com/loginform.aspx?lang=no",
PL : "https://account.asus.com/loginform.aspx?lang=pl-pl",
RO : "https://account.asus.com/loginform.aspx?lang=ro-ro",
RU : "https://account.asus.com/loginform.aspx?lang=ru-ru",
SL : "https://account.asus.com/loginform.aspx?lang=sl-si",
SV : "https://account.asus.com/loginform.aspx?lang=sv-se",
TH : "https://account.asus.com/loginform.aspx?lang=th-th",
TR : "https://account.asus.com/loginform.aspx?lang=tr-tr",
UK : "https://account.asus.com/loginform.aspx?lang=uk-ua"
}
return faqLang['<% nvram_get("preferred_lang"); %>'] || faqLang["EN"];
}
...
document.getElementById("sw_mode_span").innerHTML = "<#832#>";
else if(sw_mode == "2"){
if(wlc_express == 1)
document.getElementById("sw_mode_span").innerHTML = "<#450#>";
else if(wlc_express == 2)
document.getElementById("sw_mode_span").innerHTML = "<#452#>";
else
document.getElementById("sw_mode_span").innerHTML = "<#448#>";
}
else if(sw_mode == "3")
document.getElementById("sw_mode_span").innerHTML = "<#427#>";
else if(sw_mode == "4")
document.getElementById("sw_mode_span").innerHTML = "<#435#>";
else
...
code +='<td><span id="proceeding_main_txt"><#361#></span><span id="proceeding_txt" style="color:#FFFFCC;"></span></td>\n';
code +='</tr>\n';
code +='</table>\n';
...
document.getElementById('selected_lang').innerHTML = "<#854#>";
}
...
if(document.getElementById("NM_connect_status")){
document.getElementById("NM_connect_status").innerHTML = "<#190#>";
document.getElementById('single_wan').className = "single_wan_connected";
}
if(rog_support && !isGundam&& current_url.indexOf("GameDashboard") != -1){
$("#wan_state_icon").removeClass("wan_icon_disconnect").addClass("wan_icon_connect");
$("#wan_state").html("<#190#>");
}
...
code += '<div style="margin: 24px 0;"><#3987#></div>';
var _str = '<#3988#>';
var _str1 = '<#3989#>';
var _temp = _str.replace('%1$@', 'WiFi radio').replace('%2$@', _str1);
code += '<div style="margin: 24px 0;">'+ _temp +'</div>';
code += '<div style="margin: 32px 0;"><input id="radio_hint_checkbox" type="checkbox"><#3990#></div>';
...
code += '<div id="applyBtn" class="button-container button-container-sm" style="margin: 0 12px;" onclick="radio_agree();"><div class="button-icon button-icon-check"></div><div class="button-text"><#3989#></div></div>';
code += '</div></div>';
obj.html(code);
}
...
var $pwd_strength_container = $("<div>").addClass("pwd_strength_container").attr("id", "scorebarBorder"+postfix).attr("title", "<#348#>");
