...
document.form.wl_wpa_psk.value = "<#3535#>";
...
document.getElementById('WPS_hideSSID_hint').innerHTML = "<#3729#>";
...
chkPass(document.form.wl_wpa_psk_org.value, "");
...
x.options[0].text = "<#3577#>";
x.options[0].value = "lower";
}
else if ((CurrentCh >= 5) && (CurrentCh <= 7)){
x.options[0].text = "<#3577#>";
x.options[0].value = "lower";
add_option(document.form.wl_nctrlsb, "<#3578#>", "upper");
...
x.options[0].text = "<#3578#>";
x.options[0].value = "upper";
if (option_length >=14){
add_option(document.form.wl_nctrlsb, "<#3577#>", "lower");
...
document.getElementById('wl_NOnly_note').innerHTML = '<br>* <#3712#>';
else{
document.getElementById('wl_NOnly_note').innerHTML = '<br>* <#3716#>';
}
...
document.form.wl_nmode_x.options[0] = new Option("<#154#>", 0);
...
free_options(obj);
obj.options[0] = new Option("<#154#>", val);
obj.selectedIndex = 0;
}
...
obj.options[0] = new Option("<#154#>", 0);
...
success: function(response){
$("#auto_channel").html("<#3531#>: " + cur_control_channel[wl_unit]);
...
<div>&nbsp;</div>
<div class="formfonttitle"><#371#> - <#372#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#908#></div>
...
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0,27);"><#2983#></a></th>
<td>
...
<div id="radio_smartcon_enable" class="left" style="width: 94px;display:table-cell;"></div><div id="smartcon_rule_link" style="display:table-cell; vertical-align: middle;"><a href="Advanced_Smart_Connect.asp" style="font-family:Lucida Console;color:#FC0;text-decoration:underline;cursor:pointer;"><#2986#></a></div>
<div class="clear"></div>
...
<option class="content_input_fd" value="0" <% nvram_match("wl_bss_enabled", "0","selected"); %>><#3604#></option>
<option class="content_input_fd" value="1" <% nvram_match("wl_bss_enabled", "1","selected"); %>><#3603#></option>
</select>
</td>
</tr-->
<tr>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 2);"><#3626#></a></th>
<td>
<input type="radio" value="1" name="wl_closed" class="input" onClick="return change_common_radio(this, 'WLANConfig11b', 'wl_closed', '1')" <% nvram_match("wl_closed", "1", "checked"); %>><#188#>
<input type="radio" value="0" name="wl_closed" class="input" onClick="return change_common_radio(this, 'WLANConfig11b', 'wl_closed', '0')" <% nvram_match("wl_closed", "0", "checked"); %>><#187#>
<span id="WPS_hideSSID_hint" style="display:none;"></span>
</td>
</tr>
<tr>
<th><a id="wl_mode_desc" class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 4);"><#3665#></a></th>
<td>
...
<span id="wl_optimizexbox_span" style="display:none"><input type="checkbox" name="wl_optimizexbox_ckb" id="wl_optimizexbox_ckb" value="<% nvram_get("wl_optimizexbox"); %>" onclick="document.form.wl_optimizexbox.value=(this.checked==true)?1:0;"> <#3667#></input></span>
<span id="wl_gmode_checkbox" style="display:none;"><input type="checkbox" name="wl_gmode_check" id="wl_gmode_check" value="" onClick="wl_gmode_protection_check();"> <#3666#></input></span>
<span id="wl_nmode_x_hint" style="display:none;"><br><#3713#><br></span>
...
<th>
<a id="he_mode_text" class="hintstyle" href="javascript:void(0);" onClick=""><#3579#></a>
</th>
<td>
<div style="display:flex;align-items: center;">
<select name="wl_11ax" class="input_option" onChange="he_frame_mode(this);">
<option value="1" <% nvram_match("wl_11ax", "1" ,"selected"); %> ><#3603#></option>
<option value="0" <% nvram_match("wl_11ax", "0" ,"selected"); %> ><#3604#></option>
</select>
<span id="he_mode_faq" style="padding: 0 10px"><#3580#></span>
</div>
</td>
</tr>
<tr id="mbo_field" style="display:none">
<th>
<a class="hintstyle"><#3544#></a>
</th>
<td>
<div style="width:465px;display:flex;align-items: center;">
<select name="wl_mbo_enable" class="input_option" onChange="handleMFP();">
<option value="1" <% nvram_match("wl_mbo_enable", "1","selected"); %>><#3603#></option>
<option value="0" <% nvram_match("wl_mbo_enable", "0","selected"); %>><#3604#></option>
</select>
</div>
</td>
</tr>
...
<th>
<a class="hintstyle"><#3594#></a>
</th>
<td>
<div style="width:465px;display:flex;align-items: center;">
<select name="wl_twt" class="input_option">
<option value="1" <% nvram_match("wl_twt", "1","selected"); %>><#3603#></option>
<option value="0" <% nvram_match("wl_twt", "0","selected"); %>><#3604#></option>
</select>
</div>
</td>
</tr>
...
<div><span id="dfs_checkbox" style="display:none"><input type="checkbox" onClick="check_DFS_support(this);" name="acs_dfs_checkbox" <% nvram_match("acs_dfs", "1", "checked"); %>><#3574#></input></span></div>
<div><span id="acs_band1_checkbox" style="display:none;"><input type="checkbox" onClick="check_acs_band1_support(this);" <% nvram_match("acs_band1", "1", "checked"); %>><#3572#></input></span></div>
<div><span id="acs_band3_checkbox" style="display:none;"><input type="checkbox" onClick="check_acs_band3_support(this);" <% nvram_match("acs_band3", "1", "checked"); %>><#3573#></input></span></div>
<div><span id="acs_ch13_checkbox" style="display:none;"><input type="checkbox" onClick="check_acs_ch13_support(this);" <% nvram_match("acs_ch13", "1", "checked"); %>><#3571#></input></span></div>
</div>
</td>
</tr>
...
<option class="content_input_fd" value="0" <% nvram_match("wl_edmg_channel", "0","selected"); %>><#154#></option>
</select>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 7);"><#3676#></a></th>
<td>
...
<option value="0" <% nvram_match("wl_mfp", "0", "selected"); %>><#3604#></option>
<option value="1" <% nvram_match("wl_mfp", "1", "selected"); %>><#3658#></option>
<option value="2" <% nvram_match("wl_mfp", "2", "selected"); %>><#3659#></option>
</select>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 11);"><#3687#></a></th>
