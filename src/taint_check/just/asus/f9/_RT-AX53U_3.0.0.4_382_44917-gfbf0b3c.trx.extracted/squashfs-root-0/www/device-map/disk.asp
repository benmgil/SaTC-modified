...
disk_list_array = { "info" : ["<#1693#>", "disk.asp"], "health" : ["<#1686#>", "disk_utility.asp"], "format" : ["<#1608#>", "disk_format.asp"]};
...
<p class="formfonttitle_nwm"><#2608#>:</p>
...
<tr>
<td style="padding:5px 10px 0px 15px;">
<p class="formfonttitle_nwm"><#1387#>:</p>
...
<tr>
<td style="padding:5px 10px 0px 15px;">
<p class="formfonttitle_nwm"><#3113#>:</p>
...
<p class="formfonttitle_nwm" style="float:left;width:138px;"><#766#>:</p>
<input type="button" class="button_gen" onclick="goUPnP();" value="<#1476#>" >
<div style="margin-top:5px;" class="line_horizontal"></div>
</td>
</tr>
<tr id="aidisk_hyperlink">
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:138px;"><#977#>:</p>
<input type="button" class="button_gen" onclick="gotoAidisk();" value="<#1476#>" >
<div style="margin-top:5px;" class="line_horizontal"></div>
</td>
</tr>
<tr id="dmLink" style="display:none;">
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:138px;"><#1729#>:</p>
<input type="button" class="button_gen" onclick="gotoDM();" value="<#1476#>" >
<div style="margin-top:5px;" class="line_horizontal"></div>
</td>
</tr>
</table>
...
<tr>
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:138px; "><#2901#>:</p>
<input id="show_remove_button" class="button_gen" type="button" class="button" onclick="remove_disk_call();" value="<#1477#>">
<div id="show_removed_string" style="display:none;"><#2899#></div>
<div style="margin-top:5px;" class="line_horizontal"></div>
</td>
</tr>
</table>
...
<tr>
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:138px; " onmouseover="parent.overHint(24);" onmouseout="parent.nd();"><#2919#></p>
...
<li><#1709#><a href="/" target="_parent"><#1710#></a><#1711#></li>
</ul>
</div>
