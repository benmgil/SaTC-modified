...
var category_title = ["", "<#876#>", "<#887#>", "<#880#>", "<#889#>","<#875#>", "<#882#>", "<#891#>"];
...
$("#dualwan_primary_title").html("<#1802#> - "+dualwan_primary_display+" (LAN Port "+wans_lanport_orig+")");
}
else{
$("#dualwan_primary_title").html("<#1802#> - "+dualwan_primary_display);
}
...
$("#dualwan_secondary_title").html("<#1809#> - "+dualwan_secondary_display+" (LAN Port "+wans_lanport_orig+")");
}
else{
$("#dualwan_secondary_title").html("<#1809#> - "+dualwan_secondary_display);
}
...
if(adaptiveqos_support){
document.getElementById('content_title').innerHTML = "<#2524#> - <#884#>";
if(document.form.qos_enable.value == "1"){
if(qos_type == 0){ //Traditional Type
add_option(document.getElementById("settingSelection"), '<#2833#>', 3, 0);
add_option(document.getElementById("settingSelection"), '<#2832#>', 4, 0);
}
...
document.getElementById('content_title').innerHTML = "<#367#> - <#2524#>";
...
alert("<#3312#> "+ (qos_xobw_orig/1024).toFixed(2));
document.form.obw.focus();
document.form.obw.select();
return false;
}
...
alert("<#3312#> "+(qos_xobw1_orig/1024).toFixed(2));
document.form.obw1.focus();
document.form.obw1.select();
return false;
}
...
document.form.PC_devicename.focus();
alert(document.form.PC_devicename.value + " <#326#>");
return false;
}
}
}
...
document.form.PC_devicename.focus();
alert(document.form.PC_devicename.value + " <#2506#>");
return false;
}
}
}
...
code += '<thead><tr>';
if(pm_support)
code += '<td colspan="5"><#2741#>&nbsp;(<#2484#>&nbsp;32)</td>';
else
code += '<td colspan="5"><#1574#>&nbsp;(<#2484#>&nbsp;32)</td>';
code += '</tr></thead>';
code += '<tbody>';
code += '<tr>';
code += '<th style="width:60px" height="30px" title="<#2909#>">';
if(select_all_checked == 1)
code += '<div><div id="selAll" class="all_enable" style="margin: auto;width:40px;" onclick="enable_check(this);"><#1358#></div></div>';
else
code += '<div><div id="selAll" class="all_disable" style="margin: auto;width:40px;" onclick="enable_check(this);"><#1358#></div></div>';
code += '</th>';
if(pm_support)
code += '<th style="width:330px" title="Target can be a group name, IP or IP range(ex:192.168.1.5-10)"><#2663#></th>';
else
code += '<th style="width:330px"><#2663#></th>';
code += '<th style="width:130px"><#1734#></th>';
code += '<th style="width:130px"><#3248#></th>';
code += '<th style="width:90px"><#2483#></th>';
code += '</tr>';
...
code += '<input type="text" style="margin-left:10px;float:left;width:255px;" class="input_20_table" name="PC_devicename" onkeyup="device_filter(this);check_field();" placeholder="<#1157#>" autocorrect="off" autocapitalize="off" autocomplete="off">';
code += '<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" onclick="pullLANIPList(this);" title="<#2912#>">';
...
code += '</tr>';
if(qos_bw_rulelist == ""){
code += '<tr><td style="color:#FFCC00;" colspan="10"><#2285#></td></tr>';
}
else{
...
<!--[if lte IE 6.5.]><script>alert("<#1322#>");</script><![endif]-->
</div>
...
<tr>
<div class="description_down"><#883#></div>
</tr>
<tr>
<div style="margin-left:30px; margin-top:10px;">
<div class="formfontdesc" style="line-height:20px;font-size:14px;"><#885#></div>
</div>
...
<tr>
<td colspan="2">
<div class="priority priority_highest"><#2157#></div>
</td>
</tr>
<tr>
<td colspan="2">
...
<tr>
<td colspan="2">
<div class="priority priority_lowest"><#2496#></div>
</td>
</tr>
</table>
</td>
...
<input class="button_gen" type="button" onclick="save_priority();" value="<#1616#>">
</div>
</td>
</tr>
</form>
...
<#1842#>
<ul>
<li id="function_int_desc"><#1843#></li>
<li id="qos_desc"><#1846#></li>
<li><#1844#></li>
</ul>
<#1845#>
</div>
...
<th><#2128#></th>
<td colspan="2">
<input type="radio" name="nvgfn_enable" class="input" value="1" <% nvram_match("nvgfn_enable", "1", "checked"); %>><#188#>
<input type="radio" name="nvgfn_enable" class="input" value="0" <% nvram_match("nvgfn_enable", "0", "checked"); %>><#187#>
</td>
</tr>
<tr>
<th><#1823#></th>
...
<div id="qos_enable_hint" style="color:#FC0;margin:5px 0px 0px 100px;display:none"><#1850#></div>
</td>
</tr>
<tr id="qos_type_tr" style="display:none">
<th><#2831#></th>
<td colspan="3">
<input id="int_type" name="qos_type_radio" value="1" onClick="change_qos_type(this.value);" style="display:none;" type="radio" <% nvram_match("qos_type", "1","checked"); %>><a id="int_type_link" class="hintstyle" style="display:none;" href="javascript:void(0);" onClick="openHint(20, 5);"><label for="int_type"><#883#></label></a>
<input id="trad_type" name="qos_type_radio" value="0" onClick="change_qos_type(this.value);" type="radio" <% nvram_match("qos_type", "0","checked"); %>><a class="hintstyle" href="javascript:void(0);" onClick="openHint(20, 6);"><label for="trad_type"><#1853#></label></a>
<input id="bw_limit_type" name="qos_type_radio" value="2" onClick="change_qos_type(this.value);" type="radio" <% nvram_match("qos_type", "2","checked"); %>><a class="hintstyle" href="javascript:void(0);" onClick="openHint(20, 7)"><label for="bw_limit_type"><#156#></label></a>
...
<th><#1395#></th>
<td colspan="2">
<input id="auto" name="bw_setting_name" onClick="bandwidth_setting();" type="radio"><label for="auto"><#155#></label>
<input id="manu" name="bw_setting_name" onClick="bandwidth_setting();" type="radio"><label for="manu"><#364#></label>
</td>
</tr>
...
<tr id="upload_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(20, 2);"><#3248#></a></th>
<td>
...
<tr id="download_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(20, 2);"><#1734#></a></th>
<td>
...
<tr>
<td height="30" align="left" valign="top" bgcolor="#4D595D">
<div class="formfontdesc" style="line-height:20px;font-size:14px;"><#886#></div>
</td>
</tr>
</table>
