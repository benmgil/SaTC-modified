...
showtext(document.getElementById("proceeding_main_txt"), "<#358#>...");
...
showtext(document.getElementById("proceeding_main_txt"), "<#361#>");
showtext(document.getElementById("proceeding_txt"), Math.round(y)+"% <#358#>");
--seconds;
setTimeout("LoadingTime("+seconds+", '"+flag+"');", 1000);
}
else{
showtext(document.getElementById("proceeding_main_txt"), translate("<#360#>"));
...
document.getElementById("proceeding_img_text").innerHTML = "<#360#>";
y = 0;
