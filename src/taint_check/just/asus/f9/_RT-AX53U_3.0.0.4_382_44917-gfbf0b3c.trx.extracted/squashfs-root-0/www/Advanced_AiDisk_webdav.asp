...
<tr>
<td align="left">
<span class="formfonttitle"><#388#> - <#391#></span>
</td>
<td align="right">
<img onclick="go_setting('/APP_Installation.asp')" align="right" style="cursor:pointer;position:absolute;margin-left:-20px;margin-top:-30px;" title="<#368#>" src="/images/backprev.png" onMouseOver="this.src='/images/backprevclick.png'" onMouseOut="this.src='/images/backprev.png'">
</td>
</tr>
</table>
</div>
<div style="margin:5px;" class="splitLine"></div>
<div class="formfontdesc"><#3257#></div>
...
<option value="0" <% nvram_match("enable_webdav", "0","selected"); %> ><#3604#></option>
<option value="1" <% nvram_match("enable_webdav", "1","selected"); %> ><#3603#></option>
</select>
</td>
</tr>
