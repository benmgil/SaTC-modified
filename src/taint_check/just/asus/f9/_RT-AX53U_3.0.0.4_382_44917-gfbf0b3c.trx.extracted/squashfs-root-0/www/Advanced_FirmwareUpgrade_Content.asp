...
var webs_update_enable_orig = httpApi.nvramGet(["webs_update_enable"]).webs_update_enable;
var webs_update_time_orig = httpApi.nvramGet(["webs_update_time"]).webs_update_time;
...
html += "<td>";
html += '<div>';
html += '<input type="button" id="update" name="update" class="button_gen" onclick="show_offline_msg(true);" value="<#2485#>" />';
html += '<div><input type="button" id="amas_update" class="button_gen" style="margin:-33px 0px 0px 200px;display:none;" onclick="cfgsync_firmware_upgrade();" value="<#1624#>"/><div>';
html += '</div>';
html += '<div id="linkpage_div" class="button_helplink" style="margin-left:200px;margin-top:-38px;display:none;">';
html += '<a id="linkpage" target="_blank"><div style="padding-top:5px;"><#2485#></div></a>';
html += '</div>';
...
html += "<tr>";
html += "<td class='aimesh_node_category_bg' colspan='2'><#1081#></td>";
html += "</tr>";
html += "<tr>";
html += "<th>";
html += "<#829#>";
...
html += "<div id='current_version'><#97#> : <span class='checkFWCurrent'>" + FWString + "</span></div>";
html += "<div id='amesh_manual_upload_fw'>";
html += "<#2054#> : ";
html += "<span class='aimesh_fw_update_offline' style='margin-left:0px;' onclick='open_AiMesh_router_fw_upgrade();'><#1625#></span>";
html += "</div>";
html += "<div id='checkNewFW' class='checkNewFW' style='display:none;'><#98#> : <span class='checkFWResult'></span></div>";
html += "</td>";
html += "</tr>";
$("#fw_version_tr").before(html);
if(webs_update_enable_orig == 1){
$("#amas_" + mac_id + "").children().find(".checkFWCurrent").addClass("aimesh_fw_release_note");
$("#amas_" + mac_id + "").children().find(".checkFWCurrent").click({"model_name": "<#829#>", "fwver": FWString}, show_current_release_note);
}
...
if(!have_node) {
html += "<tr>";
html += "<td class='aimesh_node_category_bg' colspan='2'><#1019#></td>";
html += "</tr>";
}
html += "<tr>";
html += "<th>";
...
html += "<br>";
html += "<#1048#> : " + htmlEnDeCode.htmlEncode(alias);
html += "</th>";
html += "<td id='amas_" + mac_id + "'>";
html += "<div id='current_version'><#97#> : <span class='checkFWCurrent'>" + fwver + "</span></div>";
...
html += "</tr>";
$("#fw_version_tr").before(html);
if(online == 1 && webs_update_enable_orig == 1){
$("#amas_" + mac_id + "").children().find(".checkFWCurrent").addClass("aimesh_fw_release_note");
...
if(is_S2_sku || support_site_modelid == "GT-AC2900_SH" || support_site_modelid == "DSL-AX5400"){ //No manual
...
document.getElementById('update_states').innerHTML="<#2202#>";
...
document.getElementById('update_scan').style.display="none";
document.getElementById('update_states').innerHTML="<#269#><br><#2049#>";
document.getElementById('info_fail_faq').style.display="none";
document.getElementById('update').disabled = false;
}
else{
...
document.getElementById('update_states').innerHTML="<#307#>";
document.getElementById('info_fail_faq').style.display="none";
}
}
...
document.getElementById('update_states').style.display="";
document.getElementById('update_states').innerHTML="<#1483#>";
document.getElementById('info_fail_faq').style.display="none";
...
document.getElementById('update_scan').style.display="none";
document.getElementById('update_states').style.display="";
document.getElementById('update_states').innerHTML="<#1572#>";
document.getElementById('info_fail_faq').style.display="none";
return false;
}
}
...
document.getElementById("drword").innerHTML = "<#1572#>";
return false;
}
},
success: function(){
...
document.getElementById("drword").innerHTML = "&nbsp;&nbsp;&nbsp;<#2050#>...";
setTimeout("isDownloading();", 1000);
}
else{
...
document.getElementById("drword").innerHTML = "<#269#><br><#2049#>";
return false;
}
...
document.getElementById("drword").innerHTML = "&nbsp;&nbsp;&nbsp;<#2050#>..."+fwdl_percent;
setTimeout("isDownloading();", 1000);
}
...
document.getElementById("drword").innerHTML = "Memory space is NOT enough to upgrade on internet. Please wait for rebooting.<br><#2049#>"; /* untranslated */ //Untranslated. fw_size_higher_mem
return false;
}
...
var date_format = "<#2062#> : " + year + "/" + month + "/" + date + " " + hour + ":" + minute;
return date_format;
}
...
$amesh_ok.attr({"type" : "button", "value" : "<#1615#>"});
...
html += "<#2054#> : ";
if(_online == "0") {
html += "<span class='aimesh_fw_update_offline' style='margin-left:0px;' onclick='show_offline_msg(false);'><#1492#></span>";
amesh_offline_flag = true;
}
else {
html += "<span class='aimesh_fw_update_offline' style='margin-left:0px;' onclick='open_AiMesh_node_fw_upgrade(\"" + _node_ip + "\");'><#1625#></span>";
}
}
else {
html += "<span class='aimesh_fw_update_offline' style='margin-left:0px;text-decoration:none;cursor:none;'><#2059#></span>";
}
return html;
}
...
alert("You uploaded a wrong firmware to upgrade the module. Please select right one and upgrade again!");
else if(upgrade_status.mobile_upgrade_now == "1")
alert("Fail to upgrade 4G modem firmware. Please wait for a while until the router reboots.");
else if(upgrade_status.mobile_upgrade_status == "3")
alert("Please contact with customer service.");
}
}
else
return;
...
<div id="loading_block2" style="margin:5px auto; width:85%;"><#270#><br><#362#></div>
...
<tr>
<td>
<div class="drword" id="drword" style="">&nbsp;&nbsp;&nbsp;&nbsp;<#361#> <#358#>...</div>
</td>
</tr>
</table>
<!--[if lte IE 6.5]><iframe class="hackiframe"></iframe><![endif]-->
...
<div class="formfontdesc"><strong><#2057#></strong>
<ol>
<li><#2055#></li>
<li><#276#></li>
<li id="fw_note2"><#2056#></li>
<li id="fw_note3"><#2048#></li>
</ol>
</div>
<br>
...
<thead>
<tr>
<td colspan="2">Auto Firmware Upgrade</td> </tr>
</thead>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(11, 14);">Auto Firmware Upgrade</a></th> <td>
...
<tr>
<th>Preferable Upgrade Time</th> <td>
...
<input type="button" id="sig_check" name="sig_check" class="button_gen" onclick="sig_version_check();" value="<#2485#>">
</div>
<div>
...
<input type="button" id="update" name="update" class="button_gen" onclick="detect_update();" value="<#2485#>" />
</div>
<div id="linkpage_div" class="button_helplink" style="margin-left:200px;margin-top:-38px;display:none;">
<a id="linkpage" target="_blank"><div style="padding-top:5px;"><#2485#></div></a>
</div>
<div id="check_states">
...
<input type="button" name="upload" class="button_gen" onclick="submitForm()" value="<#1625#>" />
</td>
</tr>
</table>
...
<thead>
<tr>
<td colspan="2">4G Modem Firmware</td>
</tr>
</thead>
<tr><th>Modem Firmware version</th><td><div id="usb_modem_act_swver"><% nvram_get("usb_modem_act_swver"); %></div></td></tr>
<tr>
<th>New Modem Firmware</th>
<td>
<input type="file" name="file" class="input" style="color:#FFCC00;*color:#000;width: 194px;">
<input type="button" name="upload" class="button_gen" onclick="upgrade_modem_fw()" value="<#1625#>" />
</td>
</tr>
</table>
</form>
