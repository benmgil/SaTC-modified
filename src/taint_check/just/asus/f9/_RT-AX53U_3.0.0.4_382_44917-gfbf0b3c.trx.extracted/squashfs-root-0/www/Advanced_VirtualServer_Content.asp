...
add_option(document.form.KnownGames, "<#713#>", 0, 1);
...
code += '<tr><td style="color:#FFCC00;" colspan="8"><#2285#></td></tr>';
else {
...
html += '<td colspan="8">' + wan_title + '<#2287#>&nbsp;(<#2484#>&nbsp;' + profileMaxNum + ')</td>';
html += '</tr>';
html += '</thead>';
html += '<tr>';
html += '<th width="16%"><#1464#></th>';
html += '<th width="15%"><#2288#></th>';
html += '<th width="15%"><#2289#></th>';
html += '<th width="17%"><#2290#></th>';
html += '<th width="8%"><#2278#></th>';
html += '<th width="17%"><#2286#></th>';
html += '<th width="6%"><#2823#></th>';
html += '<th width="6%"><#1599#></th>';
html += '</tr>';
html += '</table>';
...
.append("<option value='0'><#1802#></option>")
.append("<option value='1'><#1809#></option>")
...
<div class="formfontdesc"><li><#1994#></div>
<div class="formfontdesc" id="FTP_desc"><li><#1969#></div>
</ul>
</div>
<div class="formfontdesc" style="margin-top:-10px;">
<a id="faq" href="" target="_blank" style="font-family:Lucida Console;text-decoration:underline;"><#385#>&nbspFAQ</a>
</div>
<div class="formfontdesc" id="lb_note" style="color:#FFCC00; display:none;"><#2472#></div>
...
<tr>
<th><#2274#><input type="hidden" name="vts_num_x_0" value="<% nvram_get("vts_num_x"); %>" readonly="1" /></th>
<td>
...
<div class="apply_gen">
<input class="button_gen" onclick="editProfile('new')" type="button" value="<#3458#>">
</div>
</td>
</tr>
</tbody>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,26);"><#2289#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,25);"><#2290#></a></th>
<td>
...
<img id="pull_arrow" class="pull_arrow" height="16px;" src="images/arrow-down.gif" align="right" onclick="pullLANIPList(this);" title="<#2914#>">
...
<input id="saveProfile" class="button_gen" type="button" value="<#1615#>">
</div>
</div>
<div id="footer"></div>
</form>
