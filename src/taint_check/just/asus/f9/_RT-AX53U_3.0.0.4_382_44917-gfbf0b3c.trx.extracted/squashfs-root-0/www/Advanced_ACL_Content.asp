...
var hint = "<#1111#>";
hint += "\n";
hint += "<#1112#>".replace("#RULECOUNT", client_bind_status.sta_binding_count);
hint += "\n";
hint += "<#1114#>";
alert(hint);
return false;
...
<div>&nbsp;</div>
<div class="formfonttitle"><#371#> - <#375#></div>
...
<td colspan="2" style="color:#FFCC00;height:30px;" align="center"><#456#></td>
</tr>
<tr>
<th width="30%"><#1814#></th>
<td>
<input type="radio" name="enable_mac" value="0" onclick="enable_macMode();"><#188#>
<input type="radio" name="enable_mac" value="1" onclick="enable_macMode();"><#187#>
</td>
</tr>
<tr id="mac_filter_mode">
<th width="30%" >
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(18,1);"><#1993#></a>
</th>
<td>
...
<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;" onclick="pullWLMACList(this);" title="<#2920#>">
