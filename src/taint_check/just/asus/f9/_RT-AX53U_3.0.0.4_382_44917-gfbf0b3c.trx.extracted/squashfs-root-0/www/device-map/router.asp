...
code += '<div class="button-right"><input type="button" class="button_gen" value="<#590#>" onclick="gotoSiteSurvey();"></div>';
code += '</div>';
...
code += '<div class="info-title"><#2981#></div>';
...
code += '<div class="info-block">';
code += '<div class="info-title"><#550#></div>';
...
code += '<div class="info-block">';
code += '<div class="info-title"><#3546#></div>';
...
code += '<span><#993#> <a id="wl'+ unit +'_wpa3FaqLink" class="faq-link" target="_blank" href="https://www.asus.com/support/FAQ/1042500">FAQ</a></span>';
code += '</div>';
}
...
if(!system.lyraHideSupport){
code += '<div class="info-block">';
code += '<div class="info-title"><#839#></div>';
...
code += '<div class="info-block">';
code += '<div class="info-title"><#3723#></div>';
...
if(system.band5g2Support){
if(dwb_info.mode == '1'){
_optionArray = [['<#833#>', '0'], ['Dual-Band Smart Connect', '1']];
}
else{
if(isSupport("wifi6e")){
_optionArray = [['<#833#>', '0'], ['Tri-Band Smart Connect', '1'], ['Dual-Band Smart Connect', '3']];
}
else{
_optionArray = [['<#833#>', '0'], ['Tri-Band Smart Connect', '1'], ['5GHz Smart Connect', '2']];
}
}
}
else{
...
<div id="wireless_tab" class="tab-block tab-click" onclick="switchTab(this.id)"><#371#></div>
<div id="status_tab" class="tab-block" onclick="switchTab(this.id)"><#719#></div>
