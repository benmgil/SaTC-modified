...
if(_type == "start")
$time_setting_title.html("<span><#3955#></span>");
else
$time_setting_title.html("<span><#3956#></span>");
var get_time_setting_component = function(_type, _unit){
var time_unit_parm = {
"text":{"hour":"<#2159#>", "minute":"<#2530#>"},
...
$routine_schedule_title.html("<#3962#>");
...
return $("<div>").addClass("offtime_schedule_text").html("<#3961#>");
},
"get_offtime_schedule_dis_text" : function(){
return $("<div>").addClass("offtime_schedule_text dis").html("<#1473#> <#3961#>");
},
...
var $title = $("<div>").addClass("title").html("<#3961#>");
...
$no_data_bg.append($("<div>").addClass("no_data_text").html("<#2285#>"));
return $no_data_bg;
},
...
.replace("MON", "<#1634#>").replace("TUE", "<#1638#>").replace("WED", "<#1639#>")
.replace("THU", "<#1637#>").replace("FRI", "<#1633#>").replace("SAT", "<#1635#>")
.replace("SUN", "<#1636#>");
else
display_title = week_group.replace("Daily", "<#3968#>").replace("Weekdays", "<#3967#>").replace("Weekend", "<#3966#>");
...
var $action_ok = $("<input/>").attr({"id":"action_ok", "type":"button", "value":"<#1615#>"}).addClass("button_gen");
