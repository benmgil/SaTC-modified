...
clientHtmlTd = '<div style="color:#FC0;height:30px;text-align:center;margin-top:15px"><#1661#><img src="/images/InternetScan.gif"></div>';
else
clientHtmlTd = '<div style="color:#FC0;height:30px;text-align:center;margin-top:15px"><#2285#></div>';
}
...
var Modified_wired_term = wired_span.replace("<#3110#>", "<#3467#>");
...
var Modified_wireless_term = wireless_span.replace("<#3111#>", "WiFi");
...
var overlibStr = "<p><#357#>:</p>" + client.mac.toUpperCase();
if(client.ssid)
overlibStr += "<p>SSID:</p>" + client.ssid.replace(/"/g, '&quot;');
if(client.isLogin)
overlibStr += "<p>Logged In User:</p>YES";
if(client.isPrinter)
overlibStr += "<p><#1663#></p>YES";
if(client.isITunes)
overlibStr += "<p><#1662#></p>YES";
if(client.isWL > 0){
overlibStr += "<p><#3536#>:</p>" + isWL_map[client.isWL]["text"].replace("G", " GHz") + " (" + client.rssi + " dBm)";
if(stainfo_support) {
overlibStr += "<p>Tx Rate:</p>" + ((client.curTx != "") ? client.curTx : "-");
overlibStr += "<p>Rx Rate:</p>" + ((client.curRx != "") ? client.curRx : "-");
overlibStr += "<p><#859#>:</p>" + client.wlConnectTime;
}
}
return overlibStr;
}
...
overlibStrTmp += "<p><span>.....................................</span></p><p style='margin-top:5px'><#2511#> :</p>";
...
<#3110#>&nbsp;(<b style="font-size:10px;" id="tabWiredNum">0</b>)
</span>
</div>
<script>
...
<#3111#>&nbsp;(<b style="font-size:10px;" id="tabWirelessNum">0</b>)
</span>
...
<input type="button" id="refresh_list" class="button_gen" value="<#1618#>" style="margin-left:70px;">
<script>
