...
<link rel="icon" href="images/favicon.png"><title><#828#> - <#368#></title>
...
var fileflex_text = "<#1953#>";
function initial(){
default_apps_array = [["AiDisk", "aidisk.asp", "<#974#>", "Aidisk_png", ""],
["<#2923#>", "mediaserver.asp", "<#3253#>", "server_png", ""],
["<#2647#>", "PrinterServer.asp", "<#2646#>", "PrinterServer_png", ""],
["3G/4G", "Advanced_Modem_Content.asp", "<#2167#>", "modem_png", ""],
["<#3086#>", "Advanced_TimeMachine.asp", "<#3091#>", "TimeMachine_png", "1.0.0.1"]];
if(re_mode == "1"){
...
default_apps_array[1].splice(2,1,"<#2516#>");
}
...
if(default_apps_array.getIndexByValue2D("<#2647#>") != -1)
default_apps_array = default_apps_array.del(default_apps_array.getIndexByValue2D("<#2647#>")[0]);
}
...
if(default_apps_array.getIndexByValue2D("<#3086#>") != -1)
default_apps_array = default_apps_array.del(default_apps_array.getIndexByValue2D("<#3086#>")[0]);
}
...
document.getElementById("apps_state_desc").innerHTML = "<#3280#>";
else if(apps_state_error == 2)
document.getElementById("apps_state_desc").innerHTML = "<#3268#>";
else if(apps_state_error == 4)
document.getElementById("apps_state_desc").innerHTML = "<#3267#>";
else if(apps_state_error == 6)
document.getElementById("apps_state_desc").innerHTML = "<#3270#>";
else if(apps_state_error == 7)
document.getElementById("apps_state_desc").innerHTML = "<#3273#>";
else if(apps_state_error == 9)
document.getElementById("apps_state_desc").innerHTML = "<#3272#>";
else if(apps_state_error == 10)
document.getElementById("apps_state_desc").innerHTML = "<#3269#>";
else if(apps_state_upgrade == 0)
document.getElementById("apps_state_desc").innerHTML = "<#3279#>";
...
document.getElementById("apps_state_desc").innerHTML = "[" + cookie.get("apps_last") + "] " + "<#1836#> <b>" + Math.round(installPercent) +"</b> <span style='font-size: 16px;'>%</span>";
...
document.getElementById("apps_state_desc").innerHTML = "<#3291#>";
else{
if(apps_depend_action_target != "terminated" && apps_depend_action_target != "error"){
if(apps_depend_action_target == "")
document.getElementById("apps_state_desc").innerHTML = "<b>[" + cookie.get("apps_last") + "] " + "<#1836#> </b>";
else
document.getElementById("apps_state_desc").innerHTML = "<b>[" + cookie.get("apps_last") + "] " + "<#1836#> </b>"
+"<br> <span style='font-size: 16px;'> <#1836#>："+apps_depend_do+"</span>"
...
if(apps_state_error == 1)
document.getElementById("apps_state_desc").innerHTML = "<#3271#>";
else if(apps_state_error == 2)
document.getElementById("apps_state_desc").innerHTML = "<#3268#>";
else if(apps_state_error == 3)
document.getElementById("apps_state_desc").innerHTML = "<#3266#>";
else if(apps_state_error == 8)
document.getElementById("apps_state_desc").innerHTML = "Enable error!";
else{
document.getElementById("loadingicon").style.display = "";
document.getElementById("apps_state_desc").innerHTML = "<#485#>";
}
}
else if(apps_state_update != 2 && apps_state_update != ""){
errorcode = "apps_state_update = " + apps_state_update;
if(apps_state_error == 1)
document.getElementById("apps_state_desc").innerHTML = "<#3260#>";
else if(apps_state_error == 2)
document.getElementById("apps_state_desc").innerHTML = "<#3258#>";
else
document.getElementById("apps_state_desc").innerHTML = "<#3247#>";
}
else if(apps_state_remove != 2 && apps_state_remove != ""){
errorcode = "apps_state_remove = " + apps_state_remove;
document.getElementById("apps_state_desc").innerHTML = "<#3245#>";
}
...
document.getElementById("apps_state_desc").innerHTML = "<#3261#>";
else if(apps_state_switch == 2)
document.getElementById("apps_state_desc").innerHTML = "<#3262#>";
else if(apps_state_switch == 3)
document.getElementById("apps_state_desc").innerHTML = "<#3259#>";
else
document.getElementById("apps_state_desc").innerHTML = "<#1836#>";
}
...
document.getElementById("apps_state_desc").innerHTML = "<#3256#>";
else if(apps_state_install == 2)
document.getElementById("apps_state_desc").innerHTML = "<#3263#>";
else
document.getElementById("apps_state_desc").innerHTML = "<#1386#>";
}
...
document.getElementById("apps_state_desc").innerHTML = "<#3265#>";
else if(apps_state_error == 6)
document.getElementById("apps_state_desc").innerHTML = "<#3270#>";
else if(apps_state_error == 7)
document.getElementById("apps_state_desc").innerHTML = "<#3273#>";
...
document.getElementById("apps_state_desc").innerHTML = "<#3281#>";
...
document.getElementById("apps_state_desc").innerHTML = "<b>[" + cookie.get("apps_last") + "] " + "<#1836#> </b>"
+"<br> <span style='font-size: 16px;'> <#1836#>："+_apps_depend_do+"</span>"
...
function show_apps(){
if(re_mode != "1")
document.getElementById("usbHint").innerHTML = "<#2839#>";
var counter = 0;
appnum = 0;
if(apps_array == "" && (appnet_support || appbase_support)){
apps_array = [["downloadmaster", "", "", "no", "no", "", "", "<#1723#>", "downloadmaster_png", "", "", ""],
...
if(i ==3){
htmlcode += '<div class="app_desc">' + default_apps_array[i][2] + ' <a href="https://www.asus.com/event/networks_3G4G_support/" target="_blank" style="text-decoration:underline;"><#3037#></a></div>\n';
}
else{
...
htmlcode += '<span class="app_action" onclick="apps_form(\'enable\',\''+ apps_array[i][0] +'\',\'no\');"><#3604#></span>\n';
else
htmlcode += '<span class="app_action" onclick="apps_form(\'enable\',\''+ apps_array[i][0] +'\',\'yes\');"><#3603#></span>\n';
if(sw_mode == 3 || link_internet == "2")
htmlcode += '<span class="app_action" onclick="apps_form(\'update\',\''+ apps_array[i][0] +'\',\'\');">Check update</span>\n'; /* untranslated */
if(apps_array[i][0] == "downloadmaster"){
htmlcode += '<span class="app_action" onclick="divdisplayctrl(\'none\', \'none\', \'none\', \'\');"><#1610#></span>\n';
}
else if(apps_array[i][0] == "fileflex")
htmlcode += '<span class="app_action" onclick="location.href=\'fileflex.asp\';"><#1610#></span>\n';
if( cookie.get("apps_last") == apps_array[i][0] &&
hasNewVer(apps_array[i]) &&
(sw_mode == 3 || link_internet == "2"))
htmlcode += '</div><div style="color:#FC0;margin-top:10px;"><span class="app_action" onclick="apps_form(\'upgrade\',\''+ apps_array[i][0] +'\',\'\');"><#3246#></span>\n';
else if(cookie.get("apps_last") == apps_array[i][0])
htmlcode += "</div><div style=\"color:#FC0;margin-top:10px;margin-left:10px;\"><span class=\"app_no_action\" onclick=\"\"><#2486#></span>\n";
}
else{
...
htmlcode += '<span class="app_action" onclick="_appname=\''+apps_array[i][0]+'\';check_usb_app_dev();"><#1835#></span>\n'; /* untranslated */
else
htmlcode += '<span class="app_action" onclick="apps_form(\'install\',\''+ apps_array[i][0] +'\',\''+ partitions_array[i] +'\');"><#1835#></span>\n'; /* untranslated */
}
...
if(accessableSize > 1)
htmlcode += '<div class="app_desc"><#1387#>: <b>'+ accessableSize+" GB" + '</b></div>';
else
htmlcode += '<div class="app_desc"><#1387#>: <b>'+ accessableSize+" GB <span style=\'color:#FFCC00\'>(Disk quota can not less than 1GB)" + '</span></b></div>';
htmlcode += '<div class="app_desc"><#3113#>: <b>'+ totalSize+" GB" + '</b></div>';
...
if(re_mode == "1")
htmlcode += '<tr height="360px"><td colspan="2" class="perNode_nohover"><span class="app_name" style="line-height:100%"><#2672#></span></td></tr>\n';
else
htmlcode += '<tr height="360px"><td colspan="2" class="nohover"><span class="app_name" style="line-height:100%"><#2672#></span></td></tr>\n';
}
document.getElementById("partition_div").innerHTML = htmlcode;
document.getElementById("usbHint").innerHTML = "<#1724#> :";
});
}
...
document.getElementById("quick_dmlink").onclick = function(){alert("<#1721#>");return false;}
}
document.getElementById("return_btn").style.display = "";
}
if(flag4 == "none")
...
<span class="formfonttitle" style="font-size: 18px;"><#368#></span>
<span style="float:right;">
<img id="return_btn" onclick="reloadAPP();" align="right" style="cursor:pointer;position:absolute;margin-left:-40px;margin-top:-25px; display:none;" title="<#368#>" src="/images/backprev.png" onMouseOver="this.src='/images/backprevclick.png'" onMouseOut="this.src='/images/backprev.png'">
</span>
</div>
</td>
</tr>
...
<span style="margin-left:15px;" id="apps_state_desc"><#1367#></span>
...
<table>
<tr>
<td><div class="top-heading" style="cursor:pointer;margin-top:10px;height:20px;" id="quick_dmlink"><a id="realLink" href="" target="_blank"><b style="text-decoration:underline;color:#FC0;font-size:16px;"><#1726#></b></></a></div></td>
...
<br>
<li>
<a id="faq" href="" target="_blank" style="text-decoration:underline;font-size:14px;font-weight:bolder;color:#FFF"><#1729#> FAQ</a>
</li>
<li style="margin-top:10px;">
<a id="faq2" href="" target="_blank" style="text-decoration:underline;font-size:14px;font-weight:bolder;color:#FFF"><#1729#> Tool FAQ</a>
</li>
<li style="margin-top:10px;">
<a id="DMUtilityLink" href="http://dlcdnet.asus.com/pub/ASUS/wireless/RT-AC5300/UT_Download_Master_2228_Win.zip" style="text-decoration:underline;font-size:14px;font-weight:bolder;color:#FFF"><#1722#></a>
</li>
</ul>
</td>
</tr>
