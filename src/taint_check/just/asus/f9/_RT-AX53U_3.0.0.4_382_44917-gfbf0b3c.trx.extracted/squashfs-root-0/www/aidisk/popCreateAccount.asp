...
showtext(document.getElementById("alert_msg2"),"*<#347#>");
document.getElementById("password").focus();
document.getElementById("password").select();
return false;
}
...
<thead>
<tr>
<td colspan="2"><span style="color:#FFF"><#895#></span><img src="../images/button-close.gif" onClick="parent.hidePop('OverlayMask');"></td>
</tr>
</thead>
<tbody>
<tr align="center">
<td height="25" colspan="2"><#894#></td>
</tr>
<tr>
<th><#945#>: </th>
<td>
...
<tr>
<th colspan="2" align="right"><input id="Submit" type="button" class="button_gen" value="<#1593#>"></td> </tr>
</table>
</form>
</body>
</html>
