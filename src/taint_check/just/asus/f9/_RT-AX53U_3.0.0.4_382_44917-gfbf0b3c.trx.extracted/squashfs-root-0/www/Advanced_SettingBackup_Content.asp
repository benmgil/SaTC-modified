...
showtext(document.getElementById("loading_block2"), "<#2905#>");
...
showtext(document.getElementById("loading_block2"), "<#2928#>");
document.getElementById('loading_block3').style.display = "none";
...
/*if(findasus_support){
document.getElementById('loading_block3').innerHTML = "<div><#426#></div>";
}else{*/
document.getElementById('loading_block3').innerHTML = "<div><#360#>.<#340#></div>";
}
},
success: function(){
...
<div>&nbsp;</div>
<div class="formfonttitle"><#399#> - <#404#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#2941#></div>
<table width="100%" border="1" align="center" cellpadding="6" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
<tr>
<th width="25%" align="right">
<a id="factorydefault_hint" class="hintstyle" href="javascript:void(0);" onclick="openHint(19,4)"><#2935#></a>
</th>
<td colspan = "4">
<div style="float:left;">
<input class="button_gen" onclick="restoreRule('restore');" type="button" value="<#1620#>" name="action1" />
</div>
...
<span><label for="restoreInit"><#2938#></label></span>
</div>
</div>
...
<a class="hintstyle" href="javascript:void(0);" onclick="openHint(19,2)"><#2940#></a>
</th>
<td>
<div style="float:left;display:table-cell">
<input class="button_gen" onclick="saveSetting('Router');" type="button" value="<#2940#>" name="action2" />
</div>
...
<span><label for="remove_passwd"><#2945#></span></label>
</div>
</div>
...
<div style="float:left;width:80%;">
<span><label for="transfer_ddns"><#1651#></span></label>
</div>
</div>
</div>
</td>
...
<tr>
<th align="right">
<a class="hintstyle" href="javascript:void(0);" onclick="openHint(19,3)"><#2944#></a>
</th>
<td colspan = "4">
...
<tr>
<td style="border:0px">
<input type="button" class="button_gen" onclick="selectSetting();" value="<#1625#>"/>
</td>
