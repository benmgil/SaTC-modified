...
var title5_2 = 0;
if(itemNum == 101){
statusmenu ="<span><#3505#></span>";
}
else if(itemNum == 102){
statusmenu ="<span><#3506#></span>".replace(/LAN-*\D* 4/, wanAggr_p2_name(orig_wnaports_bond));
}
if(itemNum == 50){
statusmenu ="<span><#587#></span>";
}
if(itemNum == 85){
statusmenu ="<span><#874#></span>";
}
else if(itemNum == 86){
statusmenu ="<span><#877#><br><#866#></span>";
}
else if(itemNum == 87){
statusmenu ="<span><#888#><br><#867#></span>";
}
else if(itemNum == 88){
statusmenu ="<span><#890#><br><#869#></span>";
}
else if(itemNum == 89){
...
statusmenu ="<span><#866#></span>";
}
else if(itemNum == 92){
statusmenu ="<span><#867#></span>";
}
else if(itemNum == 93){
statusmenu ="<span><#868#></span>";
}
else if(itemNum == 94){
statusmenu ="<span><#869#></span>";
}
else if(itemNum == 95){
statusmenu ="<span><#870#></span>";
}
else if(itemNum == 96){
statusmenu ="<span><#871#></span>";
}
else if(itemNum == 97){
statusmenu ="<span><#872#></span>";
}
else if(itemNum == 103){
statusmenu ="<span><#893#></span>";
}
else if(itemNum == 104){
statusmenu ="<span><#892#></span>";
}
if(itemNum == 98){
var signal = parseInt(sim_signal);
if(isNaN(signal) || signal <= 0){
statusmenu += "<div class='StatusHint'><#2557#></div>";
}
else if(usb_state == 2 && usb_sbstate == 0 && usb_auxstate != 1){
statusmenu += "<div class='StatusHint'><#190#> <#2173#>: </div><span>" + decodeURIComponent(modem_act_provider) + "</span>";
}
else{
...
if(itemNum == 99){
if(sim_state == "1")
statusmenu += "<div class='StatusHint'><#2583#></div>";
else if(sim_state == "2"){
if( g3err_pin == "1" && pin_remaining_count < 3)
statusmenu += "<div class='StatusHint'>Wrong PIN code. Please input the correct PIN code.</div>";
else
statusmenu += "<div class='StatusHint'><#2550#></div>";
}
else if(sim_state == "3")
statusmenu += "<div class='StatusHint'><#2552#></div>";
else if(sim_state == "4")
statusmenu += "<div class='StatusHint'><#2551#></div>";
else if(sim_state == "5")
statusmenu += "<div class='StatusHint'><#2553#></div>";
else if(sim_state == "6")
statusmenu += "<div class='StatusHint'><#2602#></div>";
else if(sim_state == "-1")
statusmenu += "<div class='StatusHint'><#2582#></div>";
else if(sim_state == "-10" || sim_state == "-2")
statusmenu += "<div><#2580#></div>";
else
statusmenu += "<div><#2540#></div>";
}
if(itemNum == 24)
...
if(itemNum == 25)
statusmenu += "<span><#1237#></span>";
else if(itemNum == 23)
statusmenu += "<span><#1236#></span>";
else if(itemNum == 22)
statusmenu += "<span><#1235#></span>";
else if(itemNum == 21)
statusmenu += "<span><#1234#></span>";
else if(itemNum == 20)
statusmenu += "<span><#1233#></span>";
else if(itemNum == 19)
statusmenu += "<span><#1232#></span>";
else if(itemNum == 18)
statusmenu += "<span><#1231#></span>";
else if(itemNum == 17)
statusmenu += "<span><#1230#></span>";
else if(itemNum == 16)
statusmenu += "<span><#1229#></span>";
else if(itemNum == 15)
statusmenu += "<span><#1228#></span>";
else if(itemNum == 14)
statusmenu += "<span><#1227#></span>";
else if(itemNum == 13)
statusmenu += "<span><#1226#></span>";
else if(itemNum == 12)
statusmenu += "<span><#1225#></span>";
else if(itemNum == 11)
statusmenu += "<span><#1224#></span>";
else if(itemNum == 10)
statusmenu += "<span><#1223#></span>";
if(itemNum == 26)
statusmenu += "<span><#2837#></span>";
if(itemNum == "A"){
statusmenu = "<div class='StatusHint'><#883#> :</div>";
if(bwdpi_app_rulelist.indexOf('game') != -1){
modeDesc = "<#1197#>"; /* untranslated */
}
else if(bwdpi_app_rulelist.indexOf('media') != -1){
modeDesc = "<#1198#>"; /* untranslated */
}
else if(bwdpi_app_rulelist.indexOf('web') != -1){
modeDesc = "<#889#>"; /* untranslated */
}
else if(bwdpi_app_rulelist.indexOf('eLearning') != -1){
modeDesc = "<#891#>"; /* untranslated */
}
else if(bwdpi_app_rulelist.indexOf('videoConference') != -1){
modeDesc = "<#880#>"; /* untranslated */
}
else{
modeDesc = "<#1631#>"; /* untranslated */
}
...
statusmenu += "<span>" + lineDesc + "</span>";
statusmenu += "<div class='StatusHint'><#2614#> :</div>";
lineDesc = ""; /* Untranslated */
...
wifiDesc = "<b>2.4GHz -</b> <#1473#>";
else
wifiDesc = "<b>2.4GHz -</b> <#1474#>";
if(wlan1_radio_flag == "0")
wifiDesc += "<br><br><b>5GHz-1 -</b> <#1473#>";
else
wifiDesc += "<br><br><b>5GHz-1 -</b> <#1474#>";
if(wlan2_radio_flag == "0")
wifiDesc += "<br><br><b>5GHz-2 -</b> <#1473#>";
else
wifiDesc += "<br><br><b>5GHz-2 -</b> <#1474#>";
statusmenu += "<span>" + wifiDesc + "</span>";
}
else if(wl_info.band5g_support){
if(wlan0_radio_flag == "0" && wlan1_radio_flag == "0")
wifiDesc = "<b>2.4GHz -</b><br><#1473#><br><br><b>5 GHz -</b><br><#1473#>";
else if(wlan0_radio_flag == "1" && wlan1_radio_flag == "0")
wifiDesc = "<b>2.4GHz -</b><br><#1474#><br><br><b>5 GHz -</b><br><#1473#>";
else if(wlan0_radio_flag == "0" && wlan1_radio_flag == "1")
wifiDesc = "<b>2.4GHz -</b><br><#1473#><br><br><b>5 GHz -</b><br><#1474#>";
else
wifiDesc = "<b>2.4GHz -</b><br><#1474#><br><br><b>5 GHz -</b><br><#1474#>";
statusmenu += "<span>" + wifiDesc + "</span>";
}
else{
if(wlan0_radio_flag == "0")
...
statusmenu += "<div><#1605#></div>";
if(monoClient != "monoClient=")
statusmenu += "<div><#2806#>" + monoClient.substring(11, monoClient.length) + "</div>";
}
else
statusmenu += "<div><#1602#></div>";
}
if(statusmenu != "")
...
if(itemNum == 5){
statusmenu = "<span class='StatusHint'><#2671#></span>";
}
if(itemNum == 4){
...
statusmenu += '<#2614#>: ';
if(expire_day > 0)
statusmenu += '<b id="expire_day_'+i+'">'+ expire_day + '</b> <#1640#> <b id="expire_hr_'+i+'">'+ expire_hr + '</b> <#2159#> <b id="expire_min_'+i+'">' + expire_min +'</b> <#2530#>';
else if(expire_hr > 0)
statusmenu += '<b id="expire_hr_'+i+'">'+ expire_hr + '</b> <#2159#> <b id="expire_min_'+i+'">' + expire_min +'</b> <#2530#>';
else{
if(expire_min > 0)
statusmenu += '<b id="expire_min_'+i+'">' + expire_min +'</b> <#2530#>';
else
statusmenu += '<b id="expire_min_'+i+'">< 1</b> <#2530#>';
}
statusmenu += ")</span><br>";
}
}
...
statusmenu += "<div class='StatusHint'><#281#>:</div><span><#1602#></span>";
}
if(itemNum == 3){
var eLAN_str = "<#1834#>".replace(/WAN/, "LAN");
(function(){
var wans_mode = '<%nvram_get("wans_mode");%>';
...
this.hint = "<#1482#> : <#2753#> "+wans_lanport;
}
else
this.hint = "<#2827#>";
}
...
statusmenu = "<div class='StatusHint'><#1802#>:</div>";
if( wans_dualwan_array[0] == "wan")
statusmenu += "<b><#1834#> - </b><br>";
else if( wans_dualwan_array[0] == "lan")
statusmenu += "<div class='StatusHint'>"+eLAN_str+" (<#2753#> "+wans_lanport+") - </div>";
else if( wans_dualwan_array[0] == "usb"){
if(gobi_support)
statusmenu += "<div class='StatusHint'><#2592#> - </div>";
else
statusmenu += "<b><#392#> - </b><br>";
}
statusmenu += "<span>" + connect_status.primary.hint + "</span>";
statusmenu += "<div class='StatusHint'><br><#1809#>:</div>";
...
statusmenu = "<div class='StatusHint'><#3023#>:</div>";
if( wans_dualwan_array[0] == "wan")
statusmenu += "<b><#1834#> - </b><br>";
else if( wans_dualwan_array[0] == "lan")
statusmenu += "<div class='StatusHint'>"+eLAN_str+" (<#2753#> "+wans_lanport+") - </div>";
...
return "<#2614#> : <span>0</span> <#2159#> <span>0</span> <#2530#>";
else
return "<#2614#> : <span>"+EHours+"</span> <#2159#> <span>"+EMinutes+"</span> <#2530#>";
}
...
statusmenu = "<span class='StatusClickHint' onclick='cancel_dblog();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1883#></span>";
_caption = "System Diagnostic capture";
}
else if(hint_show_id == 9){ //2015.07 Viz add for bwdpi : Adaptive QoS mode
statusmenu = "<span class='StatusClickHint' onclick='priority_change();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#873#></span><br>";
statusmenu += "<span class='StatusClickHint' onclick='qos_disable();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1848#></span>";
_caption = "<#883#>";
}
else if(hint_show_id == 8){ //2014.10 Viz add for dsl dslx_diag_state
statusmenu = "<span class='StatusClickHint' onclick='cancel_diag();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1883#></span>";
...
if(gobi_support){
statusmenu += "<#2578#></span>"
_caption = "<#2592#>";
}
else{
statusmenu += "<#2134#></span>"
_caption = "<#392#>";
}
}
}
...
statusmenu = "<span class='StatusClickHint' onclick='gotocooler();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1859#></span>";
_caption = "Perfomance Tuning";
}
else if(hint_show_id == 4){
statusmenu = "<span class='StatusClickHint' onclick='gotoguestnetwork();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#2133#></span>";
...
statusmenu = "<span class='StatusClickHint' onclick='suspendconn(0, 0);' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1683#></span>";
else{
...
statusmenu += "<#3480#></span>";
}
}
else{
if(gobi_support){
if( wans_dualwan_array[0] == "wan")
statusmenu += "<div class='StatusHint'><#1834#>:</div>";
else if( wans_dualwan_array[0] == "lan")
statusmenu += "<div class='StatusHint'>"+eLAN_str+" (<#2753#> "+wans_lanport+"):</div>";
else if( wans_dualwan_array[0] == "usb")
statusmenu += "<div class='StatusHint'><#2592#>:</div>";
...
statusmenu += "<b><#2753#> "+wans_lanport+" -</b><br>";
else if( wans_dualwan_array[0] == "usb")
statusmenu += "<b><#392#> -</b><br>";
}
...
if(gobi_support){
if( wans_dualwan_array[1] == "wan")
statusmenu += "<div class='StatusHint'><br><#1834#>:</div>";
else if( wans_dualwan_array[1] == "lan")
statusmenu += "<div class='StatusHint'><br>"+eLAN_str+" (<#2753#> "+wans_lanport+"):</div>";
else if( wans_dualwan_array[1] == "usb")
statusmenu += "<div class='StatusHint'><br><#2592#>:</div>";
}
else{
statusmenu += "<div class='StatusHint'><br><#1809#>:</div>";
if( wans_dualwan_array[1] == "wan")
...
statusmenu += "<span class='StatusClickHint' onclick='suspendconn(1, 0);' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1683#></span>";
else{
...
statusmenu += "<#1811#> <span style='font-weight:normal'>"+ usbDevicesList[i].deviceName +"</span></div>";
}
}
if(statusmenu == "")
statusmenu = "<span class='StatusHint'><#1684#></span>";
...
statusmenu += "<#3508#>";
statusmenu += "<ol>";
statusmenu += "<li><#3509#></li>".replace(/LAN-*\D* 4/, wanAggr_p2_name(orig_wnaports_bond));
statusmenu += "<li><#3510#></li>";
statusmenu += "<li><#3511#></li>";
statusmenu += "<li><#3512#></li>";
statusmenu += "</ol>";
statusmenu += "<#3513#>";
statusmenu += "</div>";
...
if (typeof ol_text=='undefined') var ol_text='<#927#>';
...
if(flag == 'http_passwd' && (is_KR_sku || is_S2_sku)){
...
if (nScore >= 0 && nScore < 20) { sComplexity = "<#1238#>"; }
else if (nScore >= 20 && nScore < 40) { sComplexity = "<#461#>"; }
else if (nScore >= 40 && nScore < 60) { sComplexity = "<#462#>"; }
else if (nScore >= 60 && nScore < 80) { sComplexity = "<#463#>"; }
else if (nScore >= 80 && nScore <= 100) { sComplexity = "<#464#>"; }
}
else{
if (nScore >= 0 && nScore < 20) { sComplexity = "<a href='Advanced_Wireless_Content.asp' target='_blank'><#460#></a>"; }
else if (nScore >= 20 && nScore < 40) { sComplexity = "<a href='Advanced_Wireless_Content.asp' target='_blank'><#461#></a>"; }
else if (nScore >= 40 && nScore < 60) { sComplexity = "<a href='Advanced_Wireless_Content.asp' target='_blank'><#462#></a>"; }
else if (nScore >= 60 && nScore < 80) { sComplexity = "<a href='Advanced_Wireless_Content.asp' target='_blank'><#463#></a>"; }
else if (nScore >= 80 && nScore <= 100) { sComplexity = "<a href='Advanced_Wireless_Content.asp' target='_blank'><#464#></a>"; }
}
