...
alert("<#3311#> "+document.form.ipv6_dhcp_start_start.value);
...
<option value="disabled" <% nvram_match("ipv6_service", "disabled", "selected"); %>><#1472#></option>
<option value="dhcp6" <% nvram_match("ipv6_service", "dhcp6", "selected"); %>><#2318#></option>
<option value="other" <% nvram_match("ipv6_service", "other", "selected"); %>><#2322#></option>
<option value="ipv6pt" <% nvram_match("ipv6_service", "ipv6pt", "selected"); %>><#2309#></option>
<option value="flets" <% nvram_match("ipv6_service", "flets", "selected"); %>><#2308#></option>
<option value="6to4" <% nvram_match("ipv6_service", "6to4", "selected"); %>><#2325#></option>
<option value="6in4" <% nvram_match("ipv6_service", "6in4", "selected"); %>><#2324#></option>
<option value="6rd" <% nvram_match("ipv6_service", "6rd", "selected"); %>><#2326#></option>
</select>
<span id="ipv6plus_passthrough_hint" style="display:none;"><br>It is recommended to select type of IPv6 Passthrough while WAN connection type is <#2319#>.</span>
</td>
</tr>
<tr>
<th><#3469#></th>
...
<option class="content_input_fd" value="eth" <% nvram_match("ipv6_ifdev", "eth","selected"); %>><#3467#></option>
</select>
</td>
</tr>
<tr style="display:none;"><th>DHCP-PD</th>
<td>
<input type="radio" name="ipv6_dhcp_pd" class="input" value="1" onclick="showInputfield2('ipv6_dhcp_pd', this.value);" <% nvram_match("ipv6_dhcp_pd", "1","checked"); %>><#3603#>
<input type="radio" name="ipv6_dhcp_pd" class="input" value="0" onclick="showInputfield2('ipv6_dhcp_pd', this.value);" <% nvram_match("ipv6_dhcp_pd", "0","checked"); %>><#1472#>
</td>
</tr>
<tr style="display:none;"><th>Accept Default Route</th> <td>
<input type="radio" name="_ipv6_accept_defrtr" class="input" value="1" <% nvram_match("ipv6_accept_defrtr", "1","checked"); %>><#3603#>
<input type="radio" name="_ipv6_accept_defrtr" class="input" value="0" <% nvram_match("ipv6_accept_defrtr", "0","checked"); %>><#1472#>
</td>
</tr>
...
<th><#2302#></th>
<td>
<input type="radio" name="ipv6_6rd_dhcp" class="input" value="1" onclick="showInputfield2('ipv6_6rd_dhcp', this.value);" <% nvram_match("ipv6_6rd_dhcp", "1","checked"); %>><#3603#>
<input type="radio" name="ipv6_6rd_dhcp" class="input" value="0" onclick="showInputfield2('ipv6_6rd_dhcp', this.value);" <% nvram_match("ipv6_6rd_dhcp", "0","checked"); %>><#1472#>
</td>
</tr>
<tr style="display:none;">
<th><#2304#></th>
...
<th><#301#></th>
<td>
<input type="radio" name="ipv6_dnsenable" class="input" value="1" onclick="showInputfield2('ipv6_dnsenable', this.value);" <% nvram_match("ipv6_dnsenable", "1","checked"); %>><#3603#>
<input type="radio" name="ipv6_dnsenable" class="input" value="0" onclick="showInputfield2('ipv6_dnsenable', this.value);" <% nvram_match("ipv6_dnsenable", "0","checked"); %>><#1472#>
<span id="ipv6plus_hint" style="display:none;"><br>It is recommended to enable this setting while WAN connection type is <#2319#>.</span><div id="yadns_hint" style="display:none;"></div>
</td>
</tr>
<tr style="display:none;">
<th><#2311#> 1</th>
...
<th><#1819#></th>
<td>
<input type="radio" name="_ipv6_radvd" class="input" value="1" <% nvram_match("ipv6_radvd", "1","checked"); %>><#3603#>
<input type="radio" name="_ipv6_radvd" class="input" value="0" <% nvram_match("ipv6_radvd", "0","checked"); %>><#1472#>
</td>
</tr>
</table>
<div class="apply_gen">
