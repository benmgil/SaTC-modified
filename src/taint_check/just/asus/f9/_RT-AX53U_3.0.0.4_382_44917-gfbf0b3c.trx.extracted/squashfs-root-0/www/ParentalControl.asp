...
<title id="web_title"><#828#> - <#457#></title>
...
document.getElementById('content_title').innerHTML = "<#1250#> - <#3085#>";
document.getElementById('desc_title').innerHTML = "<#2704#>";
document.getElementById('web_title').innerHTML = "<#828#> - <#3085#>";
document.getElementById('PC_enable').innerHTML = "<#2702#>";
...
code +='<thead><tr><td colspan="4"><#1574#>&nbsp;(<#2484#>&nbsp;'+MaxRule_parentctrl+')</td></tr></thead>';
code += '<tr><th width="15%" height="30px" title="<#2909#>">';
code += '<select id="selAll" class="input_option" onchange="selectAll();">';
code += '<option value=""><#2909#></option>';
code += '<option value="0"><#1472#></option>';
code += '<option value="1"><#1705#></option>';
code += '<option value="2"><#1401#></option>';
code += '</select>';
code += '</th>';
code += '<th width="45%"><#1484#> (<#2775#>)</th>';
code +='<th width="20%"><#2711#></th>';
code +='<th width="20%"><#2483#></th></tr>';
code += '<tr><td style="border-bottom:2px solid #000;">';
code += '<select id="newrule_Enable" class="input_option">';
code += '<option value="0"><#1472#></option>';
code += '<option value="1" selected><#1705#></option>';
code += '<option value="2"><#1401#></option>';
code += '</select>';
code += '</td>';
...
code +='<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;" onclick="pullLANIPList(this);" title="<#2912#>">';
...
code += '<option value="0" ' + ((client_time_obj.enable == "0") ? "selected" : "") + '><#1472#></option>';
code += '<option value="1" ' + ((client_time_obj.enable == "1") ? "selected" : "") + '><#1705#></option>';
code += '<option value="2" ' + ((client_time_obj.enable == "2")? "selected" : "") + '><#1401#></option>';
code += '</select>';
code += '</td>';
...
var hint = "<#3959#>".replace("#MAXNUM", weekScheduleApi.data_max);
hint += "\n";
hint += "<#3960#>";
alert(hint);
return false;
...
code += "<span class=\"clicked\"><#3085#></span>";
code += '<a href="AiProtection_WebProtector.asp">';
code += "<span style=\"margin-left:10px\" class=\"click\"><#1173#></span>";
code += '</a>';
}
else{
code += '<a href="AiProtection_WebProtector.asp">';
code += "<span class=\"click\"><#3085#></span>";
code += '</a>';
code += "<span style=\"margin-left:10px\" class=\"clicked\"><#1173#></span>";
}
...
<tr>
<td align="left">
<div id="content_title" class="formfonttitle" style="width:400px"><#457#></div>
</td>
<td>
...
<table class="block_filter_name_table"><tr><td style="line-height:13px;"><#1173#></td></tr></table>
</div>
</a>
...
<table class="block_filter_name_table_pressed"><tr><td style="line-height:13px;"><#3085#></td></tr></table>
</div>
</div>
<td>
</tr>
...
<span id="desc_note" style="color:#FC0;"><#905#></span>
<ol style="color:#FC0;margin:-5px 0px 3px -18px;*margin-left:18px;">
<li><#2698#></li>
<li id="nat_desc"><#2700#></li>
</ol>
</td>
</tr>
</table>
