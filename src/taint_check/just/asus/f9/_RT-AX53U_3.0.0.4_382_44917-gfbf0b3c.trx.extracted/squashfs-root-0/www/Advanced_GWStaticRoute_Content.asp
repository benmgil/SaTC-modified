...
<div class="formfontdesc"><#2878#></div>
...
<th><#2877#></th>
<td>
<input type="radio" value="1" name="sr_enable_x" class="input" onclick="return change_common_radio(this, 'RouterConfig', 'sr_enable_x', '1')" <% nvram_match("sr_enable_x", "1", "checked"); %>><#188#>
<input type="radio" value="0" name="sr_enable_x" class="input" onclick="return change_common_radio(this, 'RouterConfig', 'sr_enable_x', '0')" <% nvram_match("sr_enable_x", "0", "checked"); %>><#187#>
</td>
</tr>
</table>
...
<thead>
<tr>
<td colspan="6" id="GWStatic"><#2876#>&nbsp;(<#2484#>&nbsp;32)</td>
</tr>
</thead>
<tr>
<th><a href="javascript:void(0);" onClick="openHint(6,1);"><div class="table_text"><#2880#></div></a></th>
<th><a href="javascript:void(0);" onClick="openHint(6,2);"><div class="table_text"><#2881#></div></a></th>
<th><a href="javascript:void(0);" onClick="openHint(6,3);"><div class="table_text"><#2879#></div></a></th>
<th><a href="javascript:void(0);" onClick="openHint(6,4);"><div class="table_text"><#2882#></div></a></th>
<th><a href="javascript:void(0);" onClick="openHint(6,5);"><div class="table_text"><#3469#></div></a></th>
<th><#2483#></th>
</tr>
<tr>
<td width="20%">
...
<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;" onclick="pullLANIPList(this);" title="<#2914#>">
