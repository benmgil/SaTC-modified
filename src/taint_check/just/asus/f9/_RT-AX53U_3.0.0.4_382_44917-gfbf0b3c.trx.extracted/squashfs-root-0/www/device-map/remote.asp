...
function initial(){
if(re_status == -1){
showtext(document.getElementById("Connstatus"), "<#448#>");
document.getElementById("remoteIP_tr").style.display = "none";
setTimeout("set_re_status();",6000);
}
else
set_re_status();
document.getElementById("remoteIP_span").innerHTML = (remoteIP == "")?"<#1362#>":remoteIP;
}
function set_re_status(){
re_status = parent.getConnectingStatus();
if(re_status == 2){
showtext(document.getElementById("Connstatus"), "<#190#>");
document.getElementById("remoteIP_tr").style.display = "";
}
else{
showtext(document.getElementById("Connstatus"), "<#1604#>");
document.getElementById("remoteIP_tr").style.display = "none";
}
}
</script>
...
<tr>
<th><#1364#></th>
<td><input type="button" class="button_gen" value="<#1476#>" onclick="javascript:parent.location.href='../survey.htm';"></td>
</tr>
</table>
</body>
</html>
