...
document.getElementById("check_ip_input").innerHTML="<#326#>";
...
alert(document.form.wan_ipaddr_x.value + " <#326#>");
document.form.wan_ipaddr_x1.focus();
return false;
}
...
alert(document.form.wan_ipaddr_x1.value + "<#311#>");
document.form.wan_ipaddr_x1.focus();
document.form.wan_ipaddr_x1.select();
return false;
}
...
if(!groupChar(c)){
alert('<#332#> '+o.value.charAt(i)+' <#333#>');
o.focus();
o.select();
return false;
}
