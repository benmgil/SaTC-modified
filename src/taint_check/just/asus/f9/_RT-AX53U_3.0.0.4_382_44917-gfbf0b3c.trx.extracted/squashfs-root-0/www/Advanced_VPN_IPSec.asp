...
$(".ipsec_inactive.renew_hint").show().html("<br><#3442#>");
}
}
});
...
var set_ddns_text = '<a href="../Advanced_ASUSDDNS_Content.asp" target="_blank" style="text-decoration: underline; font-family:Lucida Console;"><#3450#></a>';
...
alert(document.form.ipsec_clients_start.value+" <#326#>");
...
ipConflict = checkIPConflict("LAN", ipsecLanIPAddr, ipsecLanNetMask);
if(ipConflict.state) {
alert("<#2343#>: " + ipConflict.ipAddr + ",\n" + "<#2648#>: " + ipConflict.netLegalRangeStart + " ~ " + ipConflict.netLegalRangeEnd);
document.form.ipsec_clients_start.focus();
document.form.ipsec_clients_start.select();
return false;
}
...
html += "<div class='ipsec_connect_status_title'><#3022#></div>";
html += "<div class='ipsec_connect_status_title'><#859#></div>";
html += "<div class='ipsec_connect_status_title'><#3407#> <#2722#></div>";
...
<input class="button_gen" onclick="clear_viewLog();" type="button" value="<#1597#>"/>
<input class="button_gen" onclick="save_viewLog();" type="button" value="<#1616#>"/>
<input class="button_gen" onclick="refresh_viewLog();" type="button" value="<#1618#>"/>
</div>
</div>
...
<th><#735#></th>
<td>
<input class="button_gen" onclick="viewLog()" type="button" value="<#1596#>"/>
</td>
</tr>
<tr class="ipsec_setting_content">
<th><#768#></th>
...
<th><#3400#></th>
<td>
<input id="ipsec_preshared_key" name="ipsec_preshared_key" type="password" autocapitalization="off" onBlur="switchType(this, false);" onFocus="switchType(this, true);" class="input_25_table" maxlength="32" placeholder="<#3392#>" autocomplete="off" autocorrect="off" autocapitalize="off">
...
<span style="color:#FC0"><#1917#></span>
</td>
</tr>
<tr>
<th><#294#></th>
...
<label for='ipsec_dead_peer_detection_en' id="ipsec_dead_peer_detection_en_label"><#3603#></label>
...
<label for='ipsec_dead_peer_detection_dis' id="ipsec_dead_peer_detection_dis_label"><#3604#></label>
</td>
</tr>
...
<th><#3331#></th>
<td>
<div><#719#> : <span id="cert_status"></span></div>
<div><#3440#> : <span id="cert_issueTo"></span></div>
<div><#3439#> : <span id="cert_issueBy"></span></div>
<div><#3371#> : <span id="cert_expire"></span></div>
<div>
<input class="button_gen_dis ipsec_active export" type="button" value="<#1475#>">
<span class="ipsec_inactive"><#717#></span>
<input type="radio" name="ipsec_export_cert" id="ipsec_export_cert_windows" class="input" value="0" checked>
<label for="ipsec_export_cert_windows"><#3444#></label>
<input type="radio" name="ipsec_export_cert" id="ipsec_export_cert_mobile" class="input" value="1">
<label for="ipsec_export_cert_mobile"><#3445#></label>
</div>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(33,2);"><#3441#></a></th>
<td style="position:relative;">
<input class="button_gen_dis ipsec_active renew" type="button" value="<#205#>">
<span class="ipsec_inactive renew_hint"><#717#></span>
