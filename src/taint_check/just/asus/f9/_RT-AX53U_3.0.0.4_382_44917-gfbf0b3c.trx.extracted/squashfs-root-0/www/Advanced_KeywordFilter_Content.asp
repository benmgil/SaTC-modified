...
<div>&nbsp;</div>
<div class="formfonttitle"><#393#> - <#397#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#1971#></div>
...
<th><#1970#></th>
<td>
<input type="radio" value="1" name="keyword_enable_x" <% nvram_match("keyword_enable_x", "1", "checked"); %>><#1605#>
<input type="radio" value="0" name="keyword_enable_x" <% nvram_match("keyword_enable_x", "0", "checked"); %>><#1602#>
</td>
</tr>
</table>
