...
var category_info = [ ["Parental Controls", "1", "<#1174#>", "<#1176#>", "<#1402#>"],
["Parental Controls", "2", "<#1174#>", "<#1176#>", "<#1403#>"],
["Parental Controls", "3", "<#1174#>", "<#1176#>", "<#1404#>"],
["Parental Controls", "4", "<#1174#>", "<#1176#>", "<#1405#>"],
["Parental Controls", "5", "<#1174#>", "<#1176#>", "<#1406#>"],
["Parental Controls", "6", "<#1174#>", "<#1176#>", "<#1407#>"],
["Parental Controls", "8", "<#1174#>", "<#1176#>", "<#1408#>"],
["Parental Controls", "9", "<#1174#>", "<#1177#>", "<#1409#>"],
["Parental Controls", "10", "<#1174#>", "<#1177#>", "<#1410#>"],
["Parental Controls", "14", "<#1174#>", "<#1177#>", "<#1411#>"],
["Parental Controls", "15", "<#1174#>", "<#1177#>", "<#1412#>"],
["Parental Controls", "16", "<#1174#>", "<#1177#>", "<#1413#>"],
["Parental Controls", "25", "<#1174#>", "<#1177#>", "<#1414#>"],
["Parental Controls", "26", "<#1174#>", "<#1177#>", "<#1415#>"],
["Parental Controls", "11", "<#1174#>", "<#1178#>", "<#1416#>"],
["Parental Controls", "24", "<#1189#>", "<#1179#>", "<#1417#>"],
["Parental Controls", "51", "<#1189#>", "<#1180#>", "<#1418#>"],
["Parental Controls", "53", "<#1189#>", "<#1181#>", "<#1419#>"],
["Parental Controls", "89", "<#1189#>", "<#1181#>", "<#1420#>"],
["Parental Controls", "42", "<#1189#>", "<#1182#>", "<#1421#>"],
["Parental Controls", "56", "<#1192#>", "<#1194#>", "<#1422#>"],
["Parental Controls", "70", "<#1192#>", "<#1194#>", "<#1423#>"],
["Parental Controls", "71", "<#1192#>", "<#1194#>", "<#1424#>"],
["Parental Controls", "57", "<#1192#>", "<#1195#>", "<#1425#>"],
["Parental Controls", "69", "<#1196#>", "<#1198#>", "<#1426#>"],
["Parental Controls", "23", "<#1196#>", "<#1199#>", "<#1427#>"],
["Home Protection", "91", "Anti-Trojan detecting and blocked", "", "<#1428#>"],
["Home Protection", "39", "Malicious site blocked", "", "<#1429#>"],
["Home Protection", "73", "Malicious site blocked", "", "<#1430#>"],
["Home Protection", "74", "Malicious site blocked", "", "<#1431#>"],
["Home Protection", "75", "Malicious site blocked", "", "<#1432#>"],
["Home Protection", "76", "Malicious site blocked", "", "<#1433#>"],
["Home Protection", "77", "Malicious site blocked", "", "<#1434#>"],
["Home Protection", "78", "Malicious site blocked", "", "<#1435#>"],
["Home Protection", "79", "Malicious site blocked", "", "<#1436#>"],
["Home Protection", "80", "Malicious site blocked", "", "<#1437#>"],
["Home Protection", "81", "Malicious site blocked", "", "<#1438#>"],
["Home Protection", "82", "Malicious site blocked", "", "<#1439#>"],
["Home Protection", "83", "Malicious site blocked", "", "<#1440#>"],
["Home Protection", "84", "Malicious site blocked", "", "<#1441#>"],
["Home Protection", "85", "Malicious site blocked", "", "<#1442#>"],
["Home Protection", "86", "Malicious site blocked", "", "<#1443#>"],
["Home Protection", "88", "Malicious site blocked", "", "<#1444#>"],
["Home Protection", "92", "Malicious site blocked", "", "<#1445#>"],
["Home Protection", "94", "Malicious site blocked", "", "<#1446#>"],
["Home Protection", "95", "Malicious site blocked", "", "<#1447#>"]
];
var target_info = {
url: "",
category_id: "",
...
var parental_string = "";
code = "<ul>";
code += "<li><div><span class='desc_info'><#1660#>:</span><br>" + target_info.desc + "</div></li>";
if(casenum != "")
code += "<li><div><span class='desc_info'>URL: </span>" + target_info.url +"</div></li>";
if(target_info.category_type == "Parental Controls")
code += "<li><div><span class='desc_info'><#1184#> :</span>" + target_info.content_category + "</div></li>";
code += "</ul>";
document.getElementById('detail_info').innerHTML = code;
if(target_info.category_type == "Parental Controls"){ //Webs Apps filter
code_title = "<div class='er_title' style='height:auto;'><#1454#></div>";
code_suggestion = "<ul>";
code_suggestion += "<li><span><#1453#></span></li>";
code_suggestion += "<li><span><#1458#></span></li>";
code_suggestion += '<li><#1244#><a href="https://global.sitesafety.trendmicro.com/index.php" target="_blank"><#1245#></a></li>';
code_suggestion += "</ul>";
...
code_title = "<div class='er_title' style='height:auto;'><#1452#></div>";
code_suggestion = "<ul>";
...
code_title = "<div class='er_title' style='height:auto;'><#794#></div>";
document.getElementById('main_reason').innerHTML = "<#793#>";
code = "";
code += "<div><#804#></div>";
document.getElementById('detail_info').innerHTML = code;
code_suggestion = "<ul>";
code_suggestion += "<li><span><#805#></span></li>";
code_suggestion += "<li><span><#806#></span></li>";
code_suggestion += "</ul>";
$("#go_btn").click(function(){
...
code_title = "<div class='er_title' style='height:auto;'><#1459#></div>"
code_suggestion = "<ul>";
if(bwdpi_support)
parental_string = "<#3085#>";
else
parental_string = "<#457#>";
code_suggestion += "<li><#1456#> "+ parental_string +" <#1457#></li>";
code_suggestion += "<li><#1458#></li>";
code_suggestion += "</ul>";
$("#go_btn").click(function(){
...
<div class="prod_madelName"><#829#></div>
<div id="main_reason" class="p1 title_gap"><#1449#></div>
<div ></div>
<div>
...
<div class="p1 title_gap"><#813#></div>
<div>
<div class="p1 title_gap"></div>
<div class="nologin">
...
<div id="go_btn" class='button' style="display:none;"><#1476#></div>
</div>
</body>
</html>
