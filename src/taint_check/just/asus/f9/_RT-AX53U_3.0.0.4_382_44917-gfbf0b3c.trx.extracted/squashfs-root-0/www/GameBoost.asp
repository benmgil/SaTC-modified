...
<link rel="icon" href="images/favicon.png"><title><#828#> - <#2065#></title>
...
var code = '';
code += '<thead><tr><td colspan="4"><#2106#>&nbsp;(<#2484#>&nbsp;64)</td></tr></thead>';
code += '<tr>';
code += '<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,10);"><#1484#> (<#2775#>)</a></th>';
code += '<th><#2483#></th>';
code += '</tr>';
code += '<tr>';
code += '<td width="40%">';
...
code += '<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;*margin-left:-3px;*margin-top:1px;" onclick="pullLANIPList(this);" title="<#2915#>">';
...
<div style="padding: 5px 0;font-size:20px;"><#2103#></div>
</td>
<td colspan="2">
<div style="padding: 5px 10px;font-size:20px;color:#FFCC66"><#2104#></div>
</td>
</tr>
<tr>
<td colspan="3">
...
<div style="font-size:16px;color:#949393;padding-left:10px;"><#2105#></div>
<div onclick="showGameListField();" class="btn" style="margin: 12px 0;width:100px;height:40px;line-height: 40px;text-align: center;border-radius: 5px;font-size:18px;"><#1593#></div>
</td>
<td>
...
<tr>
<td style="width:200px">
<div style="padding: 5px 0;font-size:20px;"><#2120#></div>
</td>
<td colspan="2">
<div style="padding: 5px 10px;font-size:20px;color:#FFCC66"><#2121#></div>
</td>
</tr>
<tr>
<td colspan="3">
...
<td style="width:400px;height:120px;">
<div style="font-size:16px;color:#949393;padding-left:10px;"><#2122#></div>
</td>
<td>
...
<td colspan="2">
<div style="padding: 5px 10px;font-size:20px;color:#FFCC66"><#2123#></div>
</td>
</tr>
<tr>
<td colspan="3">
...
<td style="width:400px;height:120px;">
<div style="font-size:16px;color:#949393;padding-left:10px;"><#2124#></div>
</td>
<td>
<div class="btn" style="margin:auto;width:100px;height:40px;text-align:center;line-height:40px;font-size:18px;cursor:pointer;border-radius:5px;" onclick="location.href='GameProfile.asp';"><#1476#></div>
</td>
</tr>
<tr style="height:50px;"></tr>
<tr id='wtfast_1' style="display:none">
<td style="width:200px">
<div style="padding: 5px 0;font-size:20px;"><#2080#></div>
</td>
<td colspan="2">
...
<td style="width:400px;height:120px;">
<div style="font-size:16px;color:#949393;padding-left:10px;"><#2077#></div>
</td>
<td>
<div class="btn" style="margin:auto;width:100px;height:40px;text-align:center;line-height:40px;font-size:18px;cursor:pointer;border-radius:5px;" onclick="location.href='Advanced_WTFast_Content.asp';"><#1476#></div>
</td>
</tr>
...
<td>
<div class="btn" style="margin:auto;width:100px;height:40px;text-align:center;line-height:40px;font-size:18px;cursor:pointer;border-radius:5px;" onclick="location.href='GameBoost_Tencent.asp';"><#1476#></div>
</td>
</tr>
</tbody>
</table>
