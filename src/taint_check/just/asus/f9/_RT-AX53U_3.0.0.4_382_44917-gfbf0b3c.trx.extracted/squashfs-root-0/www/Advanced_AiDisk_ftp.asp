...
document.getElementById("loginMethod").innerHTML = "<#949#>";
document.getElementById("accountMask").style.display = "none";
}
else{
document.getElementById("loginMethod").innerHTML = "<#948#>";
...
text += "<br>";
text += "<a id='ftp_port_conflict_faq' href='" + usb_port_conflict_faq + "' target='_blank' style='text-decoration:underline;color:#FC0;'><#1863#></a>";
...
confirm_str_off= "<#1565#>"; //"<#1567#>"+ By Viz 2011.09
confirm_str_on = "<#1569#>";
}
else if(protocol == "ftp"){
status = this.FTP_status;
confirm_str_off = "<#1566#>";
confirm_str_on = "<#1570#>";
...
account_group_menu_code += '<div class="noAccount" id="noAccount"><#2673#></div>\n'
else{
...
alert("<#2353#> " + maximum_account + " <#2354#>");
return false;
}
else
...
document.getElementById("createAccountBtn").onmouseover = function(){};
document.getElementById("createAccountBtn").onmouseout = function(){};
document.getElementById("createAccountBtn").title = (accounts.length < 11)?"<#895#>":"<#862#>";
}
...
document.getElementById("TLS_disabled").innerHTML = (flag==1)? "":"<#3289#>";
...
<span class="formfonttitle"><#388#> - <#390#></span>
<span id="returnBtn" class="returnBtn">
<img onclick="go_setting('/APP_Installation.asp')" align="right" title="<#368#>" src="/images/backprev.png" onMouseOver="this.src='/images/backprevclick.png'" onMouseOut="this.src='/images/backprev.png'">
</span>
</div>
<div id="splitLine" class="splitLine"></div>
<div class="formfontdesc" style="margin-top: 10px;"><#2046#></div>
</td>
</tr>
<tr>
<td>
...
<td>
<input type="radio" name="ftp_tls" class="input" value="1" <% nvram_match_x("", "ftp_tls", "1", "checked"); %> onChange="secure_check(1);"><#188#>
<input type="radio" name="ftp_tls" class="input" value="0" <% nvram_match_x("", "ftp_tls", "0", "checked"); %> onChange="secure_check(0);"><#187#>
<span id="TLS_disabled" style="color:#FC0;margin-left:10px;"></span>
</td>
</tr>
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(17,1);"><#2959#></a>
</th>
<td>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(17,9);"><#2953#></a>
</th>
<td>
<select name="ftp_lang" class="input_option">
<option value="CN" <% nvram_match("ftp_lang", "CN", "selected"); %>>GBK</option><!-- <#2956#> -->
<option value="TW" <% nvram_match("ftp_lang", "TW", "selected"); %>>Big5</option><!-- <#2955#> -->
<option value="EN" <% nvram_match("ftp_lang", "EN", "selected"); %>>UTF-8</option><!--<#2954#>-->
<option value="RU" <% nvram_match("ftp_lang", "RU", "selected"); %>><#2957#></option>
<option value="CZ" <% nvram_match("ftp_lang", "CZ", "selected"); %>><#2958#></option>
</select>
</td>
</tr>
</table>
...
<td><div id="createAccountBtn" title="<#895#>"></div></td>
<td><div id="deleteAccountBtn" title="<#1656#>"></div></td>
<td><div id="modifyAccountBtn" title="<#2607#>"></div></td>
</tr>
<tr id="trPMGroup" style="display:none;">
<td>
<select name="" id="user_type" class="input_option" onchange="switchUserType(this.value);">
<option value="group"><#2720#></option>
<option value="account"><#2722#></option>
</select>
</td>
</tr>
</table>
...
<table align="right">
<tr>
<td><div id="createFolderBtn" title="<#897#>"></div></td>
<td><div id="deleteFolderBtn" title="<#1659#>"></div></td>
<td><div id="modifyFolderBtn" title="<#2610#>"></div></td>
</tr>
</table>
</td>
</tr>
...
<div id="machine_name" class="machineName"><#829#></div>
</td>
<td>
...
<input name="changePermissionBtn" id="changePermissionBtn" type="button" value="<#1616#>" class="button_gen_dis" disabled="disabled">
</div>
</td>
</tr>
</table>
