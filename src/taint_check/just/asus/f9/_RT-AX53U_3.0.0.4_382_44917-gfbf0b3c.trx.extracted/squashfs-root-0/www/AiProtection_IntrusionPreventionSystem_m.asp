...
code += '</div></div>';
code += '<div class="table-cell" data-title="<#1207#>">'+ dataObj[eventID].level +'</div>';
code += '<div class="table-cell" data-title="Type">'+ direct_type[dataObj[eventID].attackType] +'</div>';
code += '<div class="table-cell" data-title="<#1169#>">'+ dataObj[eventID].source[0] +'</div>';
code += '<div class="table-cell" data-title="<#1168#>">'+ dataObj[eventID].destination[0] +'</div>';
code += '<div class="table-cell" data-title="<#1170#>">'+ dataObj[eventID].title +'</div>';
code += '</div>';
}
}
else{
$('#deleteData').hide();
code += '<div class="no-data"><#2285#></div>';
}
...
<div>
<div class="card-bg">
<div class="page-title"><#1266#></div>
<div class="split-Line"></div>
<div class="description-bar">
<div class="description-title"><#1660#></div>
<div class="description"><#1267#></div>
</div>
<div class="tm-logo">
