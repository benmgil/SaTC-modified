...
document.getElementById("natAccelDesc").innerHTML = "<#2621#>";
}
else{
document.getElementById("natAccelDesc").innerHTML = "<#2617#>";
}
}
else{
...
if(ctf_disable == 1){
document.getElementById("ctfLevelDesc").innerHTML = "<#2617#>";
}
else{
if(ctf_fa_mode == '2')
document.getElementById("ctfLevelDesc").innerHTML = "<#2619#>";
else
document.getElementById("ctfLevelDesc").innerHTML = "<#2618#>";
}
}
show_menu();
if(lacp_support){
...
else if(based_modelid == "RT-ACRH18" || based_modelid == "4G-AC86U" || based_modelid == "4G-AX56" || based_modelid == "RT-AX53U"){//MTK
...
<div>&nbsp;</div>
<div class="formfonttitle"><#378#> - <#3039#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#3043#></div>
<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
<tr id="jumbo_tr">
<th><#2373#></th>
<td>
<select name="jumbo_frame_enable" class="input_option">
<option class="content_input_fd" value="0" <% nvram_match("jumbo_frame_enable", "0","selected"); %>><#3604#></option>
<option class="content_input_fd" value="1" <% nvram_match("jumbo_frame_enable", "1","selected"); %>><#3603#></option>
</select>
</td>
</tr>
<tr id="ctf_tr" style="display: none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(29,2);"><#2615#></a></th>
<td>
<select name="ctf_disable_force" class="input_option" disabled>
<option class="content_input_fd" value="1" <% nvram_match("ctf_disable_force", "1","selected"); %>><#3604#></option>
<option class="content_input_fd" value="0" <% nvram_match("ctf_disable_force", "0","selected"); %>><#154#></option>
</select>
&nbsp
...
<option class="content_input_fd" value="0" <% nvram_match("qca_sfe", "0","selected"); %>><#3604#></option>
<option class="content_input_fd" value="1" <% nvram_match("qca_sfe", "1","selected"); %>><#3603#></option>
</select>
&nbsp
...
<option class="content_input_fd" value="0" <% nvram_match("hwnat", "0","selected"); %>><#3604#></option>
<option class="content_input_fd" value="1" <% nvram_match("hwnat", "1","selected"); %>><#154#></option>
</select>
&nbsp
<span id="natAccelDesc"></span>
</td>
...
<th><#3044#></th>
<td>
<input type="radio" name="gro_disable_force" value="0" <% nvram_match("gro_disable_force", "0", "checked"); %>><#188#>
<input type="radio" name="gro_disable_force" value="1" <% nvram_match("gro_disable_force", "1", "checked"); %>><#187#>
</td>
</tr>
<tr id="lacp_tr" style="display:none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(29,1);"><#2626#></a></th>
<td>
<select name="lacp_enabled" class="input_option" onchange="check_bonding_policy(this);" disabled>
<option class="content_input_fd" value="0" <% nvram_match("lacp_enabled", "0","selected"); %>><#3604#></option>
<option class="content_input_fd" value="1" <% nvram_match("lacp_enabled", "1","selected"); %>><#3603#></option>
</select>
<div id="lacp_desc" style="display:none"><span id="lacp_note"><#2629#></span><div>
</td>
</tr>
...
<option value="0"><#1601#></option>
<option value="1"><#3042#></option>
<option value="2"><#3041#></option>
</select>
</td>
</tr>
</table>
