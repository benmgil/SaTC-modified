...
document.getElementById("asus_eula_title").innerHTML = "<#132#>";
document.getElementById("alexa_ifttt").style.display = "none";
}
else if(alexa_support && !ifttt_support){
document.getElementById("asus_eula_title").innerHTML = "<#131#>";
...
<div>&nbsp;</div>
<div id="formfonttitle" class="formfonttitle"><#399#> - <#3909#></div>
...
<div class="eula_withdraw_title" id="asus_eula_title"><#130#></div>
<div class="eula_withdraw_content">
<div><#133#></div>
<div><#134#></div>
<div style="margin-top:5px;"><#135#>
<ol style="margin-top:0px;">
<li><#136#></li>
<li><#137#></li>
<li id="alexa_ifttt"><#139#></li>
</ol>
</div>
</div>
<div style="text-align: center;">
<div style="margin: 0px auto 10px;">
<input class="button_gen" id="asus_withdraw_btn" onclick="withdraw_eula('asus');" type="button" value="<#152#>"/>
...
<div class="eula_withdraw_title"><#148#></div>
<div class="eula_withdraw_content">
<div><#149#></div>
<div style="margin-top:5px;"><#150#>
<div><#146#></div>
<div><#147#></div>
</div>
</div>
<div style="text-align:center;">
<div style="margin: 0px auto 10px;">
<input class="button_gen" id="tm_withdraw_btn" onclick="withdraw_eula('tm');" type="button" value="<#152#>"/>
