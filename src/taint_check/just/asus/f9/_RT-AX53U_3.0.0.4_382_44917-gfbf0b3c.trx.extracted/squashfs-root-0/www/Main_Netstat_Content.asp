...
<script>
option_netstat = new Array("<#2970#>","<#2974#>","<#2975#>","<#2973#>","<#2976#>","<#2971#>","<#1712#>");
optval_netstat = new Array("-a","-t","-u","-w","-x","-l","-r");
option_netstat_nat = new Array("<#2635#>", "<#2636#>", "<#2637#>");
...
document.getElementById("cmdDesc").innerHTML = "<#2656#>";
...
<div>&nbsp;</div>
<div class="formfonttitle"><#2649#> - Netstat</div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc" id="cmdDesc"><#2656#></div>
...
<option value="-a"><#2970#></option>
<option value="-ta"><#2974#></option>
<option value="-ua"><#2975#></option>
<option value="-w"><#2973#></option>
<option value="-xa"><#2976#></option>
<option value="-l"><#2971#></option>
<option value="-r"><#1712#></option>
</select>
</td>
</tr>
<tr id="targetip_tr" style="display:none;">
<th width="20%"><#2663#> IP</th>
<td>
...
<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;*margin-left:-3px;*margin-top:1px;" onclick="pullLANIPList(this);" title="<#2913#>">
...
<option value="-r state" selected><#2642#></option>
<option value="-r src"><#2640#></option>
<option value="-r dst"><#2638#></option>
<option value="-r src-port"><#2641#></option>
<option value="-r dst-port"><#2639#></option>
</select>
</td>
</tr>
