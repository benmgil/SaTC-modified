...
elseif Request_Form("current_page") = "Main_WebHistory_Content.asp" then
	if Request_Form("clearLog_Flag") = "1" then
		tcWebApi_commit("WebHistory_ClearLog")
	end if
elseif Request_Form("current_page") = "Main_LogStatus_Content.asp" then	
	if Request_Form("clearLog_Flag") = "1" then
		tcWebApi_commit("LogAccess_ClearLog")
	end if
elseif Request_Form("current_page") = "Main_AccessLog_Content.asp" then
	if Request_Form("clearLog_Flag") = "1" then
		tcWebApi_commit("AccessLog_ClearLog")
	end if
