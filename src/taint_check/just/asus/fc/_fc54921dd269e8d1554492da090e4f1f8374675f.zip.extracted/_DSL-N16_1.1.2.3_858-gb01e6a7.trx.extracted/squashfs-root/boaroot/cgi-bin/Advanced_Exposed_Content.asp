...
function update_FAQ(){
	if(document.getElementById("connect_status").className == "connectstatuson"){		
		faqURL("faq", "https://www.asus.com", "/support/FAQ/", "1011723");
	}
}
</script>
</head>
...
<a id="faq" href="https://www.asus.com/US/support/FAQ/1011723" target="_blank" style="font-family:Lucida Console;text-decoration:underline;">DMZ FAQ</a>
</div>
