...
def main():
    ...
    # bin_list = [('boa', '/home/satc/src/taint_check/others/8c4/_DSL-N17U_1.1.2.3_674-g93f1da0.trx.extracted/squashfs-root/userfs/bin/boa'), ('boa', '/home/satc/src/taint_check/others/8c4/_DSL-N17U_1.1.2.3_674-g93f1da0.trx.extracted/squashfs-root-0/userfs/bin/boa'), ('cfg_manager', '/home/satc/src/taint_check/others/8c4/_DSL-N17U_1.1.2.3_674-g93f1da0.trx.extracted/squashfs-root/userfs/bin/cfg_manager')]
    print("BIN LIST:\n{0}\n".format(bin_list))
    with open("bin_list.txt", "w") as file:
        file.write(str(bin_list))
    if args.ghidra_script:
